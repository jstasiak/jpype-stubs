...
class AttributedString:
    ...
    def __init__(
        ...
        int: int,
        int2: int,
        attributeArray: typing.Union[
            typing.List["AttributedCharacterIterator.Attribute"], jpype.JArray
        ],
    ): ...
    @typing.overload
    def addAttribute(
...
class DateFormatSymbols(java.io.Serializable, java.lang.Cloneable):
    ...
    def setZoneStrings(
        ...
        stringArray: typing.Union[
            typing.List[typing.MutableSequence[str]], jpype.JArray
        ],
    ) -> None: ...
...
class Normalizer:
    @staticmethod
    def isNormalized(
        charSequence: typing.Union[java.lang.CharSequence, str], form: "Normalizer.Form"
    ) -> bool: ...
    @staticmethod
    def normalize(
        charSequence: typing.Union[java.lang.CharSequence, str], form: "Normalizer.Form"
...
class ListFormat(Format):
    ...
    def format(self, object: typing.Any) -> str: ...
    @typing.overload
    def format(self, list: java.util.List[str]) -> str: ...
    @typing.overload
    def format(
        self,
        object: typing.Any,
    ...
    def getLocale(self) -> java.util.Locale: ...
    def getPatterns(self) -> typing.MutableSequence[str]: ...
    def hashCode(self) -> int: ...
    def parse(self, string: str) -> java.util.List[str]: ...
    @typing.overload
    def parseObject(self, string: str) -> typing.Any: ...
    @typing.overload
    def parseObject(self, string: str, parsePosition: ParsePosition) -> typing.Any: ...
    ...
    class Style(java.lang.Enum["ListFormat.Style"]):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: str) -> "ListFormat.Style": ...
        @staticmethod
    ...
    class Type(java.lang.Enum["ListFormat.Type"]):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: str) -> "ListFormat.Type": ...
        @staticmethod
...
class MessageFormat(Format):
    ...
    @typing.overload
    def parse(
        self, string: str, parsePosition: ParsePosition
    ...
    def setFormats(
        self, formatArray: typing.Union[typing.List[Format], jpype.JArray]
    ) -> None: ...
