...
class BeanContextChild:
    def addPropertyChangeListener(
        self,
        string: str,
        propertyChangeListener: typing.Union[
            java.beans.PropertyChangeListener, typing.Callable
        ],
    ) -> None: ...
    def addVetoableChangeListener(
        self,
        string: str,
        vetoableChangeListener: typing.Union[
            java.beans.VetoableChangeListener, typing.Callable
        ],
    ) -> None: ...
...
class BeanContext(
    ...
    def getResource(
        self, string: str, beanContextChild: BeanContextChild
    ) -> java.net.URL: ...
...
class BeanContextMembershipEvent(BeanContextEvent):
    ...
    def __init__(
        self,
        beanContext: BeanContext,
        collection: typing.Union[java.util.Collection, typing.Sequence, typing.Set],
    ): ...
...
class BeanContextChildSupport(
    ...
    def firePropertyChange(
        self, string: str, object: typing.Any, object2: typing.Any
    ) -> None: ...
...
class BeanContextServices(BeanContext, BeanContextServicesListener):
    ...
    def getService(
        ...
        class_: typing.Type[typing.Any],
        object2: typing.Any,
        beanContextServiceRevokedListener: typing.Union[
            BeanContextServiceRevokedListener, typing.Callable
        ],
    ) -> typing.Any: ...
