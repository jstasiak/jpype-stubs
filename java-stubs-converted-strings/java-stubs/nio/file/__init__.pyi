...
class FileStore:
    ...
    def getFileStoreAttributeView(
        self, class_: typing.Type[_getFileStoreAttributeView__V]
    ) -> _getFileStoreAttributeView__V: ...
    ...
    def supportsFileAttributeView(
        self, class_: typing.Type[java.nio.file.attribute.FileAttributeView]
    ) -> bool: ...
    @typing.overload
...
class FileSystems:
    ...
    def newFileSystem(
        uRI: java.net.URI,
        map: typing.Union[
            java.util.Map[str, typing.Any], typing.Mapping[str, typing.Any]
        ],
    ) -> FileSystem: ...
    @typing.overload
    @staticmethod
    ...
    @staticmethod
    def newFileSystem(
        path: typing.Union["Path", jpype.protocol.SupportsPath],
    ) -> FileSystem: ...
    @typing.overload
    @staticmethod
    def newFileSystem(
...
class Files:
    ...
    def copy(
        path: typing.Union["Path", jpype.protocol.SupportsPath],
        path2: typing.Union["Path", jpype.protocol.SupportsPath],
    ...
    def createTempDirectory(
        string: str, *fileAttribute: java.nio.file.attribute.FileAttribute[typing.Any]
    ) -> "Path": ...
    @typing.overload
    @staticmethod
    def createTempDirectory(
    ...
    def find(
        ...
        biPredicate: typing.Union[
            java.util.function.BiPredicate[
                typing.Union["Path", jpype.protocol.SupportsPath],
    ...
    def getFileAttributeView(
        path: typing.Union["Path", jpype.protocol.SupportsPath],
        class_: typing.Type[_getFileAttributeView__V],
        *linkOption: "LinkOption",
    ...
    @staticmethod
    def newDirectoryStream(
        path: typing.Union["Path", jpype.protocol.SupportsPath], string: str
    ) -> DirectoryStream["Path"]: ...
    @typing.overload
    @staticmethod
    def newDirectoryStream(
        path: typing.Union["Path", jpype.protocol.SupportsPath],
        filter: typing.Union[
            DirectoryStream.Filter["Path"], typing.Callable[["Path"], bool]
        ],
    ) -> DirectoryStream["Path"]: ...
    @staticmethod
    def newInputStream(
    ...
    def readAttributes(
        path: typing.Union["Path", jpype.protocol.SupportsPath],
        class_: typing.Type[_readAttributes_0__A],
        *linkOption: "LinkOption",
    ...
    def setOwner(
        path: typing.Union["Path", jpype.protocol.SupportsPath],
        userPrincipal: typing.Union[
            java.nio.file.attribute.UserPrincipal, typing.Callable
        ],
    ) -> "Path": ...
    @staticmethod
    ...
    def write(
        ...
        iterable: typing.Union[
            ...
            typing.Set[java.lang.CharSequence],
...
class PathMatcher:
    def matches(
        self, path: typing.Union["Path", jpype.protocol.SupportsPath]
    ) -> bool: ...
...
class Watchable:
    ...
    def register(
        ...
        kindArray: typing.Union[typing.List[WatchEvent.Kind[typing.Any]], jpype.JArray],
        *modifier: typing.Union[WatchEvent.Modifier, typing.Callable],
    ) -> WatchKey: ...
...
class SecureDirectoryStream(
    ...
    @typing.overload
    def getFileAttributeView(
        self, class_: typing.Type[_getFileAttributeView_0__V]
    ) -> _getFileAttributeView_0__V: ...
    @typing.overload
    def getFileAttributeView(
        self,
        t: _SecureDirectoryStream__T,
        class_: typing.Type[_getFileAttributeView_1__V],
        *linkOption: LinkOption,
