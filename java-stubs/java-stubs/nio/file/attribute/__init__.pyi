...
class AclEntry:
    ...
    class Builder:
        ...
        @typing.overload
        def setFlags(
            self, set: java.util.Set["AclEntryFlag"]
        ) -> "AclEntry.Builder": ...
        @typing.overload
        def setPermissions(
        ...
        def setPrincipal(
            self, userPrincipal: typing.Union["UserPrincipal", typing.Callable]
        ) -> "AclEntry.Builder": ...
...
class PosixFileAttributeView(BasicFileAttributeView, FileOwnerAttributeView):
    ...
    def setGroup(
        self, groupPrincipal: typing.Union[GroupPrincipal, typing.Callable]
    ) -> None: ...
