...
class CompilationIDAttribute(
    ...
    @typing.overload
    @staticmethod
    def of(string: str) -> "CompilationIDAttribute": ...
    @typing.overload
    @staticmethod
    def of(
...
class EnclosingMethodAttribute(
    ...
    def of(
        ...
        optional: java.util.Optional[str],
...
class InnerClassInfo:
    ...
    def of(
        ...
        optional2: java.util.Optional[str],
        int: int,
    ) -> "InnerClassInfo": ...
    @typing.overload
    @staticmethod
...
class LocalVariableTableAttribute(
    ...
    @staticmethod
    def of(
        list: java.util.List[LocalVariableInfo],
...
class MethodParameterInfo:
    ...
    @staticmethod
    def of(
        optional: java.util.Optional[str], *accessFlag: java.lang.reflect.AccessFlag
    ) -> "MethodParameterInfo": ...
    @staticmethod
    def ofParameter(
        optional: java.util.Optional[str], int: int
    ) -> "MethodParameterInfo": ...
...
class MethodParametersAttribute(
    ...
    @staticmethod
    def of(
        list: java.util.List[MethodParameterInfo],
    ) -> "MethodParametersAttribute": ...
...
class ModuleAttribute(
    ...
    def of(
        ...
        collection: typing.Union[
            java.util.Collection["ModuleRequireInfo"],
            typing.Sequence["ModuleRequireInfo"],
            typing.Set["ModuleRequireInfo"],
        ],
        collection2: typing.Union[
            java.util.Collection["ModuleExportInfo"],
            typing.Sequence["ModuleExportInfo"],
            typing.Set["ModuleExportInfo"],
        ],
        collection3: typing.Union[
            java.util.Collection["ModuleOpenInfo"],
            typing.Sequence["ModuleOpenInfo"],
            typing.Set["ModuleOpenInfo"],
        ],
        collection4: typing.Union[
            java.util.Collection[java.lang.classfile.constantpool.ClassEntry],
            typing.Sequence[java.lang.classfile.constantpool.ClassEntry],
            typing.Set[java.lang.classfile.constantpool.ClassEntry],
        ],
        collection5: typing.Union[
            java.util.Collection["ModuleProvideInfo"],
            typing.Sequence["ModuleProvideInfo"],
            typing.Set["ModuleProvideInfo"],
        ],
    ) -> "ModuleAttribute": ...
    @typing.overload
    @staticmethod
    def of(
        ...
        consumer: typing.Union[
            java.util.function.Consumer["ModuleAttribute.ModuleAttributeBuilder"],
    ...
    class ModuleAttributeBuilder:
        ...
        def exports(
            ...
            packageDesc: java.lang.constant.PackageDesc,
            collection: typing.Union[
                java.util.Collection[java.lang.reflect.AccessFlag],
                typing.Sequence[java.lang.reflect.AccessFlag],
                typing.Set[java.lang.reflect.AccessFlag],
            ],
            *moduleDesc: java.lang.constant.ModuleDesc,
        ) -> "ModuleAttribute.ModuleAttributeBuilder": ...
        @typing.overload
        ...
        @typing.overload
        def requires(
            self, moduleDesc: java.lang.constant.ModuleDesc, int: int, string: str
        ) -> "ModuleAttribute.ModuleAttributeBuilder": ...
        @typing.overload
        def requires(
            self,
...
class ModuleHashesAttribute(
    ...
    @typing.overload
    @staticmethod
    def of(string: str, *moduleHashInfo: ModuleHashInfo) -> "ModuleHashesAttribute": ...
    @typing.overload
    @staticmethod
    def of(
        string: str, list: java.util.List[ModuleHashInfo]
...
class ModuleRequireInfo:
    ...
    @staticmethod
    def of(
        moduleDesc: java.lang.constant.ModuleDesc, int: int, string: str
    ) -> "ModuleRequireInfo": ...
    @typing.overload
    @staticmethod
    def of(
...
class ModuleTargetAttribute(
    ...
    @typing.overload
    @staticmethod
    def of(string: str) -> "ModuleTargetAttribute": ...
    @typing.overload
    @staticmethod
    def of(
        utf8Entry: java.lang.classfile.constantpool.Utf8Entry,
...
class SourceFileAttribute(
    ...
    @typing.overload
    @staticmethod
    def of(string: str) -> "SourceFileAttribute": ...
    @typing.overload
    @staticmethod
    def of(
        utf8Entry: java.lang.classfile.constantpool.Utf8Entry,
...
class SourceIDAttribute(
    ...
    @typing.overload
    @staticmethod
    def of(string: str) -> "SourceIDAttribute": ...
    @typing.overload
    @staticmethod
    def of(
        utf8Entry: java.lang.classfile.constantpool.Utf8Entry,
...
class StackMapFrameInfo:
    ...
    class SimpleVerificationTypeInfo(
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: str) -> "StackMapFrameInfo.SimpleVerificationTypeInfo": ...
        @staticmethod
...
class __module_protocol__(Protocol):
    ...
    RuntimeInvisibleAnnotationsAttribute: typing.Type[
        RuntimeInvisibleAnnotationsAttribute
    ]
    RuntimeInvisibleParameterAnnotationsAttribute: typing.Type[
        RuntimeInvisibleParameterAnnotationsAttribute
    ]
    RuntimeInvisibleTypeAnnotationsAttribute: typing.Type[
        RuntimeInvisibleTypeAnnotationsAttribute
    ]
    RuntimeVisibleAnnotationsAttribute: typing.Type[RuntimeVisibleAnnotationsAttribute]
    RuntimeVisibleParameterAnnotationsAttribute: typing.Type[
        RuntimeVisibleParameterAnnotationsAttribute
    ]
    RuntimeVisibleTypeAnnotationsAttribute: typing.Type[
        RuntimeVisibleTypeAnnotationsAttribute
    ]
