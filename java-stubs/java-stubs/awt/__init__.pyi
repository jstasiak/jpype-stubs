...
class AWTEventMulticaster(
    ...
    @staticmethod
    def add(
        actionListener: typing.Union[java.awt.event.ActionListener, typing.Callable],
        actionListener2: typing.Union[java.awt.event.ActionListener, typing.Callable],
    ) -> java.awt.event.ActionListener: ...
    @typing.overload
    @staticmethod
    def add(
        adjustmentListener: typing.Union[
            java.awt.event.AdjustmentListener, typing.Callable
        ],
        adjustmentListener2: typing.Union[
            java.awt.event.AdjustmentListener, typing.Callable
        ],
    ) -> java.awt.event.AdjustmentListener: ...
    @typing.overload
    ...
    @staticmethod
    def add(
        hierarchyListener: typing.Union[
            java.awt.event.HierarchyListener, typing.Callable
        ],
        hierarchyListener2: typing.Union[
            java.awt.event.HierarchyListener, typing.Callable
        ],
    ) -> java.awt.event.HierarchyListener: ...
    @typing.overload
    ...
    @staticmethod
    def add(
        itemListener: typing.Union[java.awt.event.ItemListener, typing.Callable],
        itemListener2: typing.Union[java.awt.event.ItemListener, typing.Callable],
    ) -> java.awt.event.ItemListener: ...
    @typing.overload
    @staticmethod
    def add(
    ...
    @staticmethod
    def add(
        mouseWheelListener: typing.Union[
            java.awt.event.MouseWheelListener, typing.Callable
        ],
        mouseWheelListener2: typing.Union[
            java.awt.event.MouseWheelListener, typing.Callable
        ],
    ) -> java.awt.event.MouseWheelListener: ...
    @typing.overload
    @staticmethod
    def add(
        textListener: typing.Union[java.awt.event.TextListener, typing.Callable],
        textListener2: typing.Union[java.awt.event.TextListener, typing.Callable],
    ) -> java.awt.event.TextListener: ...
    @typing.overload
    @staticmethod
    def add(
    ...
    @staticmethod
    def add(
        windowStateListener: typing.Union[
            java.awt.event.WindowStateListener, typing.Callable
        ],
        windowStateListener2: typing.Union[
            java.awt.event.WindowStateListener, typing.Callable
        ],
    ) -> java.awt.event.WindowStateListener: ...
    ...
    @staticmethod
    def getListeners(
        eventListener: java.util.EventListener, class_: typing.Type[_getListeners__T]
...
class Desktop:
    ...
    def setAboutHandler(
        self, aboutHandler: typing.Union[java.awt.desktop.AboutHandler, typing.Callable]
    ) -> None: ...
    def setDefaultMenuBar(self, jMenuBar: javax.swing.JMenuBar) -> None: ...
    def setOpenFileHandler(
        self,
        openFilesHandler: typing.Union[
            java.awt.desktop.OpenFilesHandler, typing.Callable
        ],
    ) -> None: ...
    def setOpenURIHandler(
        self,
        openURIHandler: typing.Union[java.awt.desktop.OpenURIHandler, typing.Callable],
    ) -> None: ...
    def setPreferencesHandler(
        self,
        preferencesHandler: typing.Union[
            java.awt.desktop.PreferencesHandler, typing.Callable
        ],
    ) -> None: ...
    def setPrintFileHandler(
        self,
        printFilesHandler: typing.Union[
            java.awt.desktop.PrintFilesHandler, typing.Callable
        ],
    ) -> None: ...
    def setQuitHandler(
        self, quitHandler: typing.Union[java.awt.desktop.QuitHandler, typing.Callable]
    ) -> None: ...
...
class Font(java.io.Serializable):
    ...
    def __init__(
        self,
        map: typing.Union[
            java.util.Map[java.text.AttributedCharacterIterator.Attribute, typing.Any],
    ...
    @staticmethod
    def createFont(
        int: int, file: typing.Union[java.io.File, jpype.protocol.SupportsPath]
    ) -> "Font": ...
    @typing.overload
    @staticmethod
    ...
    @staticmethod
    def getFont(
        string: typing.Union[java.lang.String, str], font: "Font"
    ) -> "Font": ...
    @typing.overload
    @staticmethod
    def getFont(
...
class FontMetrics(java.io.Serializable):
    ...
    @typing.overload
    def getLineMetrics(
        self, string: typing.Union[java.lang.String, str], graphics: "Graphics"
    ) -> java.awt.font.LineMetrics: ...
    @typing.overload
    def getLineMetrics(
        self,
...
class Graphics:
    ...
    def drawImage(
        ...
        int8: int,
        color: "Color",
        imageObserver: typing.Union[java.awt.image.ImageObserver, typing.Callable],
    ) -> bool: ...
    @typing.overload
    def drawImage(
        self,
...
class GraphicsConfigTemplate(java.io.Serializable):
    ...
    def getBestConfiguration(
        self,
        graphicsConfigurationArray: typing.Union[
            typing.List["GraphicsConfiguration"], jpype.JArray
        ],
...
class Image:
    ...
    def getHeight(
        self, imageObserver: typing.Union[java.awt.image.ImageObserver, typing.Callable]
    ) -> int: ...
    def getProperty(
        self,
        string: typing.Union[java.lang.String, str],
...
class ItemSelectable:
    def addItemListener(
        self, itemListener: typing.Union[java.awt.event.ItemListener, typing.Callable]
    ) -> None: ...
...
class LayoutManager:
    def addLayoutComponent(
        self, string: typing.Union[java.lang.String, str], component: "Component"
    ) -> None: ...
...
class RenderingHints(java.util.Map[typing.Any, typing.Any], java.lang.Cloneable):
    ...
    def __init__(
        self,
        map: typing.Union[
            java.util.Map["RenderingHints.Key", typing.Any],
    ...
    def putAll(
        self,
        map: typing.Union[
            java.util.Map[typing.Any, typing.Any],
...
class Taskbar:
    ...
    def setWindowProgressState(
        self, window: "Window", state: "Taskbar.State"
    ) -> None: ...
...
class Toolkit:
    def addAWTEventListener(
        self,
        aWTEventListener: typing.Union[
            java.awt.event.AWTEventListener, typing.Callable
        ],
        long: int,
    ) -> None: ...
    def addPropertyChangeListener(
    ...
    def createCustomCursor(
        self, image: Image, point: Point, string: typing.Union[java.lang.String, str]
    ) -> Cursor: ...
    ...
    def createDragGestureRecognizer(
        self,
        class_: typing.Type[_createDragGestureRecognizer__T],
        dragSource: java.awt.dnd.DragSource,
        component: "Component",
        int: int,
        dragGestureListener: typing.Union[
            java.awt.dnd.DragGestureListener, typing.Callable
        ],
...
class Component(java.awt.image.ImageObserver, MenuContainer, java.io.Serializable):
    ...
    def firePropertyChange(
        self, string: typing.Union[java.lang.String, str], byte: int, byte2: int
    ) -> None: ...
    @typing.overload
    def firePropertyChange(
        self, string: typing.Union[java.lang.String, str], char: str, char2: str
    ) -> None: ...
    @typing.overload
    def firePropertyChange(
    ...
    @typing.overload
    def firePropertyChange(
        self, string: typing.Union[java.lang.String, str], float: float, float2: float
    ) -> None: ...
    @typing.overload
    def firePropertyChange(
        self, string: typing.Union[java.lang.String, str], long: int, long2: int
    ) -> None: ...
    @typing.overload
    def firePropertyChange(
        self, string: typing.Union[java.lang.String, str], short: int, short2: int
    ) -> None: ...
    def getAccessibleContext(self) -> javax.accessibility.AccessibleContext: ...
    ...
    def getListeners(
        self, class_: typing.Type[_getListeners__T]
    ) -> typing.MutableSequence[_getListeners__T]: ...
...
class Graphics2D(Graphics):
    ...
    def setBackground(self, color: "Color") -> None: ...
    def setComposite(
        self, composite: typing.Union[Composite, typing.Callable]
    ) -> None: ...
...
class KeyboardFocusManager(KeyEventDispatcher, KeyEventPostProcessor):
    ...
    def addKeyEventDispatcher(
        self, keyEventDispatcher: typing.Union[KeyEventDispatcher, typing.Callable]
    ) -> None: ...
    def addKeyEventPostProcessor(
        self,
        keyEventPostProcessor: typing.Union[KeyEventPostProcessor, typing.Callable],
    ) -> None: ...
    @typing.overload
    def addPropertyChangeListener(
        self,
...
class MenuItem(MenuComponent, javax.accessibility.Accessible):
    ...
    @typing.overload
    def __init__(
        self, string: typing.Union[java.lang.String, str], menuShortcut: MenuShortcut
    ): ...
    def addActionListener(
        self,
        actionListener: typing.Union[java.awt.event.ActionListener, typing.Callable],
...
class CardLayout(LayoutManager2, java.io.Serializable):
    ...
    def setVgap(self, int: int) -> None: ...
    def show(
        self, container: "Container", string: typing.Union[java.lang.String, str]
    ) -> None: ...
    def toString(self) -> java.lang.String: ...
...
class Color(Paint, java.io.Serializable):
    ...
    @staticmethod
    def getColor(
        string: typing.Union[java.lang.String, str], color: "Color"
    ) -> "Color": ...
    @typing.overload
...
class TextComponent(Component, javax.accessibility.Accessible):
    def addNotify(self) -> None: ...
    def addTextListener(
        self, textListener: typing.Union[java.awt.event.TextListener, typing.Callable]
    ) -> None: ...
    def enableInputMethods(self, boolean: bool) -> None: ...
    def getAccessibleContext(self) -> javax.accessibility.AccessibleContext: ...
    def getBackground(self) -> Color: ...
...
class LinearGradientPaint(MultipleGradientPaint):
    ...
    def __init__(
        ...
        float4: float,
        floatArray: typing.Union[typing.List[float], jpype.JArray],
        colorArray: typing.Union[typing.List[Color], jpype.JArray],
    ): ...
    @typing.overload
    def __init__(
        self,
...
class Dialog(Window):
    ...
    @typing.overload
    def __init__(
        self, dialog: "Dialog", string: typing.Union[java.lang.String, str]
    ): ...
    @typing.overload
    def __init__(
        self,
    ...
    @typing.overload
    def __init__(
        self, frame: "Frame", string: typing.Union[java.lang.String, str], boolean: bool
    ): ...
    @typing.overload
    def __init__(
        self,
...
class FileDialog(Dialog):
    ...
    @typing.overload
    def __init__(
        self, dialog: Dialog, string: typing.Union[java.lang.String, str], int: int
    ): ...
    @typing.overload
    def __init__(self, frame: Frame): ...
    @typing.overload
    ...
    @typing.overload
    def __init__(
        self, frame: Frame, string: typing.Union[java.lang.String, str], int: int
    ): ...
    def addNotify(self) -> None: ...
    ...
    def setFilenameFilter(
        self, filenameFilter: typing.Union[java.io.FilenameFilter, typing.Callable]
    ) -> None: ...
