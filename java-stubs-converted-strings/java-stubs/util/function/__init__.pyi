...
class BiFunction(typing.Generic[_BiFunction__T, _BiFunction__U, _BiFunction__R]):
    ...
    def andThen(
        ...
        function: typing.Union[
            "Function"[_BiFunction__R, _andThen__V],
...
class Consumer(typing.Generic[_Consumer__T]):
    ...
    def andThen(
        ...
        consumer: typing.Union[
            "Consumer"[_Consumer__T], typing.Callable[[_Consumer__T], None]
        ],
...
class DoubleConsumer:
    ...
    def andThen(
        self, doubleConsumer: typing.Union["DoubleConsumer", typing.Callable]
    ) -> "DoubleConsumer": ...
...
class DoublePredicate:
    def and_(
        self, doublePredicate: typing.Union["DoublePredicate", typing.Callable]
    ) -> "DoublePredicate": ...
...
class DoubleUnaryOperator:
    def andThen(
        self, doubleUnaryOperator: typing.Union["DoubleUnaryOperator", typing.Callable]
    ) -> "DoubleUnaryOperator": ...
...
class Function(typing.Generic[_Function__T, _Function__R]):
    ...
    def andThen(
        self,
        function: typing.Union[
            "Function"[_Function__R, _andThen__V],
    ...
    def compose(
        self,
        function: typing.Union[
            "Function"[_compose__V, _Function__T],
...
class IntConsumer:
    ...
    def andThen(
        self, intConsumer: typing.Union["IntConsumer", typing.Callable]
    ) -> "IntConsumer": ...
...
class IntPredicate:
    def and_(
        self, intPredicate: typing.Union["IntPredicate", typing.Callable]
    ) -> "IntPredicate": ...
...
class IntUnaryOperator:
    def andThen(
        self, intUnaryOperator: typing.Union["IntUnaryOperator", typing.Callable]
    ) -> "IntUnaryOperator": ...
...
class LongConsumer:
    ...
    def andThen(
        self, longConsumer: typing.Union["LongConsumer", typing.Callable]
    ) -> "LongConsumer": ...
...
class LongPredicate:
    def and_(
        self, longPredicate: typing.Union["LongPredicate", typing.Callable]
    ) -> "LongPredicate": ...
...
class LongUnaryOperator:
    def andThen(
        self, longUnaryOperator: typing.Union["LongUnaryOperator", typing.Callable]
    ) -> "LongUnaryOperator": ...
...
class Predicate(typing.Generic[_Predicate__T]):
    def and_(
        ...
        predicate: typing.Union[
            "Predicate"[_Predicate__T], typing.Callable[[_Predicate__T], bool]
        ],
    ...
    def not_(
        predicate: typing.Union[
            "Predicate"[_not___T], typing.Callable[[_not___T], bool]
        ],
    ) -> "Predicate"[_not___T]: ...
    def or_(
        self,
