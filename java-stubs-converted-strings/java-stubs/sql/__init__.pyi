...
class Array:
    ...
    def getArray(
        self,
        map: typing.Union[
            java.util.Map[str, typing.Type[typing.Any]],
            typing.Mapping[str, typing.Type[typing.Any]],
        ],
    ) -> typing.Any: ...
    @typing.overload
...
class Driver:
    ...
    def connect(
        self, string: str, properties: java.util.Properties
    ) -> "Connection": ...
...
class DriverManager:
    ...
    @staticmethod
    def getConnection(
        string: str, properties: java.util.Properties
    ) -> "Connection": ...
    @staticmethod
...
class SQLException(java.lang.Exception, java.lang.Iterable[java.lang.Throwable]):
    ...
    @typing.overload
    def __init__(
        self, string: str, string2: str, int: int, throwable: java.lang.Throwable
    ): ...
    @typing.overload
...
class BatchUpdateException(SQLException):
    ...
    @typing.overload
    def __init__(
        self, string: str, intArray: typing.Union[typing.List[int], jpype.JArray]
    ): ...
    @typing.overload
    def __init__(
        self,
...
class Connection(Wrapper, java.lang.AutoCloseable):
    ...
    @typing.overload
    def prepareCall(
        self, string: str, int: int, int2: int, int3: int
    ) -> "CallableStatement": ...
    @typing.overload
    ...
    def prepareStatement(
        self, string: str, int: int, int2: int
    ) -> "PreparedStatement": ...
    @typing.overload
    def prepareStatement(
        self, string: str, int: int, int2: int, int3: int
...
class DatabaseMetaData(Wrapper):
    ...
    def getAttributes(
        self, string: str, string2: str, string3: str, string4: str
    ) -> "ResultSet": ...
    def getBestRowIdentifier(
        self, string: str, string2: str, string3: str, int: int, boolean: bool
    ) -> "ResultSet": ...
    ...
    def getExportedKeys(
        self, string: str, string2: str, string3: str
    ) -> "ResultSet": ...
    ...
    def getIndexInfo(
        self, string: str, string2: str, string3: str, boolean: bool, boolean2: bool
    ) -> "ResultSet": ...
...
class ResultSet(Wrapper, java.lang.AutoCloseable):
    ...
    @typing.overload
    def getObject(
        self, string: str, class_: typing.Type[_getObject_4__T]
    ) -> _getObject_4__T: ...
    @typing.overload
    def getObject(
        self,
    ...
    @typing.overload
    def updateAsciiStream(
        self, string: str, inputStream: java.io.InputStream
    ) -> None: ...
    @typing.overload
    def updateAsciiStream(
        self, string: str, inputStream: java.io.InputStream, int: int
    ) -> None: ...
    @typing.overload
    def updateAsciiStream(
        self, string: str, inputStream: java.io.InputStream, long: int
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def updateCharacterStream(
        self, string: str, reader: java.io.Reader, int: int
    ) -> None: ...
    @typing.overload
    def updateCharacterStream(
        self, string: str, reader: java.io.Reader, long: int
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def updateDate(
        self, string: str, date: typing.Union[Date, datetime.date]
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def updateObject(
        self, string: str, object: typing.Any, sQLType: SQLType
    ) -> None: ...
    @typing.overload
    def updateObject(
        self, string: str, object: typing.Any, sQLType: SQLType, int: int
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def updateRowId(
        self, string: str, rowId: typing.Union[RowId, typing.Callable]
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def updateTime(
        self, string: str, time: typing.Union[Time, datetime.time]
    ) -> None: ...
    @typing.overload
    def updateTimestamp(
    ...
    @typing.overload
    def updateTimestamp(
        self, string: str, timestamp: typing.Union[Timestamp, datetime.datetime]
    ) -> None: ...
    def wasNull(self) -> bool: ...
...
class SQLClientInfoException(SQLException):
    ...
    def __init__(
        ...
        int: int,
        map: typing.Union[
            java.util.Map[str, ClientInfoStatus], typing.Mapping[str, ClientInfoStatus]
        ],
    ): ...
    @typing.overload
    def __init__(
...
class CallableStatement(PreparedStatement):
    ...
    def registerOutParameter(
        self, string: str, sQLType: SQLType, string2: str
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def setObject(
        self, string: str, object: typing.Any, int: int, int2: int
    ) -> None: ...
    @typing.overload
    def setObject(self, int: int, object: typing.Any) -> None: ...
    @typing.overload
