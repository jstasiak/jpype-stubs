...
class FloatBuffer(Buffer, java.lang.Comparable["FloatBuffer"]):
    ...
    @typing.overload
    def get(
        self, int: int, floatArray: typing.Union[typing.List[float], jpype.JArray]
    ) -> "FloatBuffer": ...
    @typing.overload
    def get(
        self,
...
class IntBuffer(Buffer, java.lang.Comparable["IntBuffer"]):
    ...
    @typing.overload
    def get(
        self, int: int, intArray: typing.Union[typing.List[int], jpype.JArray]
    ) -> "IntBuffer": ...
    @typing.overload
    def get(
        self,
...
class LongBuffer(Buffer, java.lang.Comparable["LongBuffer"]):
    ...
    @typing.overload
    def get(
        self, int: int, longArray: typing.Union[typing.List[int], jpype.JArray]
    ) -> "LongBuffer": ...
    @typing.overload
    def get(
        self,
    ...
    @typing.overload
    def get(
        self, longArray: typing.Union[typing.List[int], jpype.JArray]
    ) -> "LongBuffer": ...
    @typing.overload
    def get(
        self,
...
class ShortBuffer(Buffer, java.lang.Comparable["ShortBuffer"]):
    ...
    @typing.overload
    def get(
        self, shortArray: typing.Union[typing.List[int], jpype.JArray]
    ) -> "ShortBuffer": ...
    @typing.overload
    def get(
        self,
