...
class BigDecimal(java.lang.Number, java.lang.Comparable["BigDecimal"], _JBigDecimal):
    ...
    @typing.overload
    def __init__(
        self, string: typing.Union[java.lang.String, str], mathContext: "MathContext"
    ): ...
    @typing.overload
    ...
    @typing.overload
    def __init__(
        self, bigInteger: "BigInteger", int: int, mathContext: "MathContext"
    ): ...
    @typing.overload
    ...
    @typing.overload
    def add(
        self, bigDecimal: typing.Union["BigDecimal", decimal.Decimal]
    ) -> "BigDecimal": ...
    @typing.overload
    def add(
        self,
        bigDecimal: typing.Union["BigDecimal", decimal.Decimal],
        mathContext: "MathContext",
    ) -> "BigDecimal": ...
    ...
    @typing.overload
    def divide(
        self, bigDecimal: typing.Union["BigDecimal", decimal.Decimal], int: int
    ) -> "BigDecimal": ...
    @typing.overload
    def divide(
        self,
...
class BigInteger(java.lang.Number, java.lang.Comparable["BigInteger"]):
    ...
    def modPow(
        self, bigInteger: "BigInteger", bigInteger2: "BigInteger"
    ) -> "BigInteger": ...
