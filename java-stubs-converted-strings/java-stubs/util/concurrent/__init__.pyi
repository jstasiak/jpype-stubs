...
class BlockingQueue(
    ...
    def drainTo(
        ...
        collection: typing.Union[
            java.util.Collection[_BlockingQueue__E],
            typing.Sequence[_BlockingQueue__E],
            typing.Set[_BlockingQueue__E],
        ],
    ) -> int: ...
    @typing.overload
    def drainTo(
...
class CompletionService(typing.Generic[_CompletionService__V]):
    ...
    def submit(
        ...
        v: _CompletionService__V,
    ) -> "Future"[_CompletionService__V]: ...
    @typing.overload
    def submit(
        self,
        callable: typing.Union[
            Callable[_CompletionService__V], typing.Callable[[], _CompletionService__V]
        ],
    ) -> "Future"[_CompletionService__V]: ...
...
class CompletionStage(typing.Generic[_CompletionStage__T]):
    def acceptEither(
        ...
        consumer: typing.Union[
            java.util.function.Consumer[_CompletionStage__T],
    ...
    def acceptEitherAsync(
        ...
        executor: typing.Union["Executor", typing.Callable],
    ) -> "CompletionStage"[None]: ...
    ...
    def applyToEither(
        ...
        function: typing.Union[
            java.util.function.Function[_CompletionStage__T, _applyToEither__U],
    ...
    def applyToEitherAsync(
        ...
        completionStage: "CompletionStage"[_CompletionStage__T],
        function: typing.Union[
            java.util.function.Function[_CompletionStage__T, _applyToEitherAsync_0__U],
    ...
    def applyToEitherAsync(
        ...
        completionStage: "CompletionStage"[_CompletionStage__T],
        function: typing.Union[
            java.util.function.Function[_CompletionStage__T, _applyToEitherAsync_1__U],
    ...
    def exceptionally(
        self,
        function: typing.Union[
            java.util.function.Function[java.lang.Throwable, _CompletionStage__T],
    ...
    def thenAcceptBoth(
        ...
        biConsumer: typing.Union[
            java.util.function.BiConsumer[_CompletionStage__T, _thenAcceptBoth__U],
    ...
    def thenApply(
        self,
        function: typing.Union[
            java.util.function.Function[_CompletionStage__T, _thenApply__U],
    ...
    def thenApplyAsync(
        self,
        function: typing.Union[
            java.util.function.Function[_CompletionStage__T, _thenApplyAsync_0__U],
    ...
    def thenApplyAsync(
        self,
        function: typing.Union[
            java.util.function.Function[_CompletionStage__T, _thenApplyAsync_1__U],
    ...
    def whenComplete(
        self,
        biConsumer: typing.Union[
            java.util.function.BiConsumer[_CompletionStage__T, java.lang.Throwable],
...
class ConcurrentLinkedDeque(
    ...
    def __init__(
        self,
        collection: typing.Union[
            java.util.Collection[_ConcurrentLinkedDeque__E],
            typing.Sequence[_ConcurrentLinkedDeque__E],
            typing.Set[_ConcurrentLinkedDeque__E],
        ],
    ): ...
    ...
    def forEach(
        self,
        consumer: typing.Union[
            java.util.function.Consumer[_ConcurrentLinkedDeque__E],
    ...
    def removeAll(
        self,
        collection: typing.Union[
            java.util.Collection[typing.Any],
    ...
    def removeIf(
        ...
        predicate: typing.Union[
            java.util.function.Predicate[_ConcurrentLinkedDeque__E],
...
class ConcurrentLinkedQueue(
    ...
    def __init__(
        ...
        collection: typing.Union[
            ...
            typing.Set[_ConcurrentLinkedQueue__E],
        ],
    ): ...
    ...
    def forEach(
        self,
        consumer: typing.Union[
            java.util.function.Consumer[_ConcurrentLinkedQueue__E],
    ...
    def removeIf(
        self,
        predicate: typing.Union[
            java.util.function.Predicate[_ConcurrentLinkedQueue__E],
...
class ConcurrentMap(
    ...
    def computeIfAbsent(
        ...
        k: _ConcurrentMap__K,
        function: typing.Union[
            java.util.function.Function[_ConcurrentMap__K, _ConcurrentMap__V],
    ...
    def forEach(
        self,
        biConsumer: typing.Union[
            java.util.function.BiConsumer[_ConcurrentMap__K, _ConcurrentMap__V],
...
class ConcurrentSkipListSet(
    ...
    def __init__(
        self,
        collection: typing.Union[
            java.util.Collection[_ConcurrentSkipListSet__E],
            typing.Sequence[_ConcurrentSkipListSet__E],
            typing.Set[_ConcurrentSkipListSet__E],
        ],
    ): ...
    @typing.overload
    def __init__(
        ...
        comparator: typing.Union[
            java.util.Comparator[_ConcurrentSkipListSet__E],
            typing.Callable[
                [_ConcurrentSkipListSet__E, _ConcurrentSkipListSet__E], int
            ],
        ],
    ): ...
    @typing.overload
...
class CopyOnWriteArrayList(
    ...
    @typing.overload
    def __init__(
        self, eArray: typing.Union[typing.List[_CopyOnWriteArrayList__E], jpype.JArray]
    ): ...
    @typing.overload
    def __init__(
        self,
        collection: typing.Union[
            java.util.Collection[_CopyOnWriteArrayList__E],
            typing.Sequence[_CopyOnWriteArrayList__E],
            typing.Set[_CopyOnWriteArrayList__E],
        ],
    ): ...
    @typing.overload
    ...
    def forEach(
        self,
        consumer: typing.Union[
            java.util.function.Consumer[_CopyOnWriteArrayList__E],
    ...
    def replaceAll(
        ...
        unaryOperator: typing.Union[
            java.util.function.UnaryOperator[_CopyOnWriteArrayList__E], typing.Callable
        ],
    ) -> None: ...
    def retainAll(
        self,
    ...
    def sort(
        self,
        comparator: typing.Union[
            java.util.Comparator[_CopyOnWriteArrayList__E],
...
class CopyOnWriteArraySet(
    ...
    def __init__(
        self,
        collection: typing.Union[
            java.util.Collection[_CopyOnWriteArraySet__E],
            typing.Sequence[_CopyOnWriteArraySet__E],
            typing.Set[_CopyOnWriteArraySet__E],
        ],
    ): ...
    ...
    def forEach(
        self,
        consumer: typing.Union[
            java.util.function.Consumer[_CopyOnWriteArraySet__E],
    ...
    def removeIf(
        self,
        predicate: typing.Union[
            java.util.function.Predicate[_CopyOnWriteArraySet__E],
...
class CyclicBarrier:
    ...
    @typing.overload
    def __init__(
        self, int: int, runnable: typing.Union[java.lang.Runnable, typing.Callable]
    ): ...
    @typing.overload
    def await_(self) -> int: ...
    @typing.overload
...
class Executors:
    ...
    @staticmethod
    def callable(
        runnable: typing.Union[java.lang.Runnable, typing.Callable], t: _callable_1__T
    ) -> Callable[_callable_1__T]: ...
    @typing.overload
    @staticmethod
    def callable(
        privilegedAction: typing.Union[
            java.security.PrivilegedAction[typing.Any], typing.Callable[[], typing.Any]
        ],
    ) -> Callable[typing.Any]: ...
    @typing.overload
    @staticmethod
    def callable(
        privilegedExceptionAction: typing.Union[
            java.security.PrivilegedExceptionAction[typing.Any],
    ...
    def newCachedThreadPool(
        threadFactory: typing.Union["ThreadFactory", typing.Callable],
    ) -> "ExecutorService": ...
    @typing.overload
    @staticmethod
    ...
    def newFixedThreadPool(
        int: int, threadFactory: typing.Union["ThreadFactory", typing.Callable]
    ) -> "ExecutorService": ...
    @typing.overload
    @staticmethod
...
class StructuredTaskScope(
    ...
    def fork(
        self,
        callable: typing.Union[Callable[_fork_1__U], typing.Callable[[], _fork_1__U]],
    ...
    def open(
        joiner: typing.Union[
            "StructuredTaskScope.Joiner"[_open_1__T, _open_1__R],
    ...
    class Configuration:
        def withName(self, string: str) -> "StructuredTaskScope.Configuration": ...
        def withThreadFactory(
            self, threadFactory: typing.Union["ThreadFactory", typing.Callable]
        ) -> "StructuredTaskScope.Configuration": ...
        def withTimeout(
    ...
    class Joiner(
        ...
        def onComplete(
            self,
            subtask: "StructuredTaskScope.Subtask"[_StructuredTaskScope__Joiner__T],
        ) -> bool: ...
        def onFork(
            self,
            subtask: "StructuredTaskScope.Subtask"[_StructuredTaskScope__Joiner__T],
...
class ArrayBlockingQueue(
    ...
    def __init__(
        ...
        boolean: bool,
        collection: typing.Union[
            java.util.Collection[_ArrayBlockingQueue__E],
            typing.Sequence[_ArrayBlockingQueue__E],
            typing.Set[_ArrayBlockingQueue__E],
        ],
    ): ...
    ...
    def forEach(
        self,
        consumer: typing.Union[
            java.util.function.Consumer[_ArrayBlockingQueue__E],
    ...
    def removeIf(
        self,
        predicate: typing.Union[
            java.util.function.Predicate[_ArrayBlockingQueue__E],
...
class CompletableFuture(
    ...
    def acceptEither(
        ...
        consumer: typing.Union[
            java.util.function.Consumer[_CompletableFuture__T],
    ...
    def applyToEither(
        ...
        completionStage: CompletionStage[_CompletableFuture__T],
        function: typing.Union[
            java.util.function.Function[_CompletableFuture__T, _applyToEither__U],
    ...
    def completeAsync(
        ...
        supplier: typing.Union[
            java.util.function.Supplier[_CompletableFuture__T],
    ...
    @staticmethod
    def delayedExecutor(
        long: int, timeUnit: TimeUnit, executor: typing.Union[Executor, typing.Callable]
    ) -> Executor: ...
    def exceptionNow(self) -> java.lang.Throwable: ...
    def exceptionally(
        self,
        function: typing.Union[
            java.util.function.Function[java.lang.Throwable, _CompletableFuture__T],
    ...
    def supplyAsync(
        supplier: typing.Union[
            java.util.function.Supplier[_supplyAsync_0__U],
    ...
    def supplyAsync(
        supplier: typing.Union[
            java.util.function.Supplier[_supplyAsync_1__U],
    ...
    def thenAcceptBoth(
        ...
        completionStage: CompletionStage[_thenAcceptBoth__U],
        biConsumer: typing.Union[
            java.util.function.BiConsumer[_CompletableFuture__T, _thenAcceptBoth__U],
    ...
    def thenApply(
        self,
        function: typing.Union[
            java.util.function.Function[_CompletableFuture__T, _thenApply__U],
    ...
    def thenApplyAsync(
        self,
        function: typing.Union[
            java.util.function.Function[_CompletableFuture__T, _thenApplyAsync_0__U],
    ...
    def thenApplyAsync(
        self,
        function: typing.Union[
            java.util.function.Function[_CompletableFuture__T, _thenApplyAsync_1__U],
    ...
    def whenComplete(
        self,
        biConsumer: typing.Union[
            java.util.function.BiConsumer[_CompletableFuture__T, java.lang.Throwable],
...
class DelayQueue(
    ...
    def __init__(
        self,
        collection: typing.Union[
            java.util.Collection[_DelayQueue__E],
            typing.Sequence[_DelayQueue__E],
            typing.Set[_DelayQueue__E],
        ],
    ): ...
...
class ExecutorService(Executor, java.lang.AutoCloseable):
    ...
    def invokeAll(
        ...
        collection: typing.Union[
            ...
            typing.Set[Callable[_invokeAll_0__T]],
        ],
    ...
    def invokeAll(
        self,
        collection: typing.Union[
            java.util.Collection[Callable[_invokeAll_1__T]],
            typing.Sequence[Callable[_invokeAll_1__T]],
            typing.Set[Callable[_invokeAll_1__T]],
        ],
        long: int,
        timeUnit: TimeUnit,
    ...
    def invokeAny(
        self,
        collection: typing.Union[
            java.util.Collection[Callable[_invokeAny_0__T]],
            typing.Sequence[Callable[_invokeAny_0__T]],
            typing.Set[Callable[_invokeAny_0__T]],
        ],
    ) -> _invokeAny_0__T: ...
    @typing.overload
    def invokeAny(
        self,
        collection: typing.Union[
            java.util.Collection[Callable[_invokeAny_1__T]],
            typing.Sequence[Callable[_invokeAny_1__T]],
            typing.Set[Callable[_invokeAny_1__T]],
        ],
        long: int,
        timeUnit: TimeUnit,
    ) -> _invokeAny_1__T: ...
    ...
    def submit(
        self,
        callable: typing.Union[
            Callable[_submit_2__T], typing.Callable[[], _submit_2__T]
        ],
    ) -> Future[_submit_2__T]: ...
...
class ForkJoinTask(
    ...
    @staticmethod
    def adapt(
        runnable: typing.Union[java.lang.Runnable, typing.Callable], t: _adapt_1__T
    ) -> "ForkJoinTask"[_adapt_1__T]: ...
    @typing.overload
    @staticmethod
    def adapt(
        callable: typing.Union[Callable[_adapt_2__T], typing.Callable[[], _adapt_2__T]],
    ...
    def adaptInterruptible(
        runnable: typing.Union[java.lang.Runnable, typing.Callable],
        t: _adaptInterruptible_1__T,
    ) -> "ForkJoinTask"[_adaptInterruptible_1__T]: ...
    @typing.overload
    @staticmethod
    def adaptInterruptible(
        callable: typing.Union[
            Callable[_adaptInterruptible_2__T],
    ...
    def invokeAll(
        collection: typing.Union[
            ...
            typing.Set[_invokeAll_0__T],
        ],
    ) -> java.util.Collection[_invokeAll_0__T]: ...
    @typing.overload
    @staticmethod
    def invokeAll(
        forkJoinTask: "ForkJoinTask"[typing.Any],
        forkJoinTask2: "ForkJoinTask"[typing.Any],
    ) -> None: ...
    @typing.overload
    @staticmethod
...
class LinkedBlockingQueue(
    ...
    def __init__(
        self,
        collection: typing.Union[
            java.util.Collection[_LinkedBlockingQueue__E],
            typing.Sequence[_LinkedBlockingQueue__E],
            typing.Set[_LinkedBlockingQueue__E],
        ],
    ): ...
    def clear(self) -> None: ...
    def contains(self, object: typing.Any) -> bool: ...
    ...
    def forEach(
        self,
        consumer: typing.Union[
            java.util.function.Consumer[_LinkedBlockingQueue__E],
    ...
    def removeIf(
        self,
        predicate: typing.Union[
            java.util.function.Predicate[_LinkedBlockingQueue__E],
...
class PriorityBlockingQueue(
    ...
    def __init__(
        ...
        int: int,
        comparator: typing.Union[
            java.util.Comparator[_PriorityBlockingQueue__E],
            typing.Callable[
                [_PriorityBlockingQueue__E, _PriorityBlockingQueue__E], int
            ],
        ],
    ): ...
    @typing.overload
    def __init__(
        self,
        collection: typing.Union[
            java.util.Collection[_PriorityBlockingQueue__E],
            typing.Sequence[_PriorityBlockingQueue__E],
            typing.Set[_PriorityBlockingQueue__E],
        ],
    ): ...
    ...
    def forEach(
        self,
        consumer: typing.Union[
            java.util.function.Consumer[_PriorityBlockingQueue__E],
    ...
    def removeIf(
        self,
        predicate: typing.Union[
            java.util.function.Predicate[_PriorityBlockingQueue__E],
...
class SynchronousQueue(
    ...
    def drainTo(
        self,
        collection: typing.Union[
            java.util.Collection[_SynchronousQueue__E],
            typing.Sequence[_SynchronousQueue__E],
            typing.Set[_SynchronousQueue__E],
        ],
    ) -> int: ...
    @typing.overload
    def drainTo(
...
class ConcurrentSkipListMap(
    ...
    def __init__(
        self,
        comparator: typing.Union[
            java.util.Comparator[_ConcurrentSkipListMap__K],
            typing.Callable[
                [_ConcurrentSkipListMap__K, _ConcurrentSkipListMap__K], int
            ],
        ],
    ): ...
    @typing.overload
    def __init__(
        self,
        map: typing.Union[
            java.util.Map[_ConcurrentSkipListMap__K, _ConcurrentSkipListMap__V],
    ...
    def forEach(
        ...
        biConsumer: typing.Union[
            ...
            typing.Callable[
                [_ConcurrentSkipListMap__K, _ConcurrentSkipListMap__V], None
            ],
        ],
    ) -> None: ...
...
class CountedCompleter(
    ...
    def onCompletion(
        self, countedCompleter: "CountedCompleter"[typing.Any]
    ) -> None: ...
...
class FutureTask(RunnableFuture[_FutureTask__V], typing.Generic[_FutureTask__V]):
    ...
    def __init__(
        self,
        callable: typing.Union[
            Callable[_FutureTask__V], typing.Callable[[], _FutureTask__V]
        ],
    ): ...
    def cancel(self, boolean: bool) -> bool: ...
    def exceptionNow(self) -> java.lang.Throwable: ...
...
class LinkedBlockingDeque(
    ...
    def __init__(
        self,
        collection: typing.Union[
            java.util.Collection[_LinkedBlockingDeque__E],
            typing.Sequence[_LinkedBlockingDeque__E],
            typing.Set[_LinkedBlockingDeque__E],
        ],
    ): ...
    ...
    def forEach(
        self,
        consumer: typing.Union[
            java.util.function.Consumer[_LinkedBlockingDeque__E],
    ...
    def removeIf(
        self,
        predicate: typing.Union[
            java.util.function.Predicate[_LinkedBlockingDeque__E],
...
class LinkedTransferQueue(
    ...
    def __init__(
        self,
        collection: typing.Union[
            java.util.Collection[_LinkedTransferQueue__E],
            typing.Sequence[_LinkedTransferQueue__E],
            typing.Set[_LinkedTransferQueue__E],
        ],
    ): ...
    ...
    def forEach(
        self,
        consumer: typing.Union[
            java.util.function.Consumer[_LinkedTransferQueue__E],
    ...
    def removeIf(
        self,
        predicate: typing.Union[
            java.util.function.Predicate[_LinkedTransferQueue__E],
...
class ScheduledExecutorService(ExecutorService):
    ...
    def schedule(
        self,
        callable: typing.Union[
            Callable[_schedule_1__V], typing.Callable[[], _schedule_1__V]
        ],
        long: int,
        timeUnit: TimeUnit,
...
class ForkJoinPool(AbstractExecutorService, ScheduledExecutorService):
    ...
    def __init__(
        self,
        int: int,
        forkJoinWorkerThreadFactory: typing.Union[
            "ForkJoinPool.ForkJoinWorkerThreadFactory", typing.Callable
        ],
        uncaughtExceptionHandler: typing.Union[
            java.lang.Thread.UncaughtExceptionHandler, typing.Callable
        ],
        boolean: bool,
    ): ...
    @typing.overload
    ...
    def invokeAllUninterruptibly(
        self,
        collection: typing.Union[
            java.util.Collection[Callable[_invokeAllUninterruptibly__T]],
            typing.Sequence[Callable[_invokeAllUninterruptibly__T]],
            typing.Set[Callable[_invokeAllUninterruptibly__T]],
        ],
    ...
    def submitWithTimeout(
        self,
        callable: typing.Union[
            Callable[_submitWithTimeout__V], typing.Callable[[], _submitWithTimeout__V]
        ],
        long: int,
        timeUnit: TimeUnit,
        consumer: typing.Union[
...
class ThreadPoolExecutor(AbstractExecutorService):
    ...
    def __init__(
        ...
        long: int,
        timeUnit: TimeUnit,
        blockingQueue: BlockingQueue[typing.Union[java.lang.Runnable, typing.Callable]],
    ): ...
    @typing.overload
    def __init__(
        self,
        ...
        timeUnit: TimeUnit,
        blockingQueue: BlockingQueue[typing.Union[java.lang.Runnable, typing.Callable]],
        rejectedExecutionHandler: typing.Union[
            RejectedExecutionHandler, typing.Callable
        ],
    ): ...
    @typing.overload
    def __init__(
...
class ScheduledThreadPoolExecutor(ThreadPoolExecutor, ScheduledExecutorService):
    ...
    @typing.overload
    def __init__(
        self, int: int, threadFactory: typing.Union[ThreadFactory, typing.Callable]
    ): ...
    @typing.overload
    def __init__(
        self,
...
class ConcurrentHashMap(
    ...
    def __init__(
        self,
        map: typing.Union[
            java.util.Map[_ConcurrentHashMap__K, _ConcurrentHashMap__V],
    ...
    def computeIfAbsent(
        ...
        k: _ConcurrentHashMap__K,
        function: typing.Union[
            java.util.function.Function[_ConcurrentHashMap__K, _ConcurrentHashMap__V],
    ...
    def forEach(
        self,
        biConsumer: typing.Union[
            java.util.function.BiConsumer[_ConcurrentHashMap__K, _ConcurrentHashMap__V],
    ...
    def forEach(
        ...
        consumer: typing.Union[
            java.util.function.Consumer[_forEach_2__U],
    ...
    def forEachEntry(
        ...
        consumer: typing.Union[
            java.util.function.Consumer[_forEachEntry_1__U],
    ...
    def forEachKey(
        ...
        long: int,
        consumer: typing.Union[
            java.util.function.Consumer[_ConcurrentHashMap__K],
    ...
    def forEachKey(
        ...
        long: int,
        function: typing.Union[
            java.util.function.Function[_ConcurrentHashMap__K, _forEachKey_1__U],
            typing.Callable[[_ConcurrentHashMap__K], _forEachKey_1__U],
        ],
        consumer: typing.Union[
            java.util.function.Consumer[_forEachKey_1__U],
    ...
    def forEachValue(
        ...
        long: int,
        consumer: typing.Union[
            java.util.function.Consumer[_ConcurrentHashMap__V],
    ...
    def forEachValue(
        ...
        long: int,
        function: typing.Union[
            java.util.function.Function[_ConcurrentHashMap__V, _forEachValue_1__U],
            typing.Callable[[_ConcurrentHashMap__V], _forEachValue_1__U],
        ],
        consumer: typing.Union[
            java.util.function.Consumer[_forEachValue_1__U],
    ...
    def newKeySet(
        int: int,
    ) -> "ConcurrentHashMap.KeySetView"[_newKeySet_1__K, bool]: ...
    def put(
    ...
    def reduce(
        ...
        biFunction2: typing.Union[
            java.util.function.BiFunction[_reduce__U, _reduce__U, _reduce__U],
    ...
    def reduceKeys(
        ...
        long: int,
        function: typing.Union[
            java.util.function.Function[_ConcurrentHashMap__K, _reduceKeys_1__U],
    ...
    def reduceKeysToDouble(
        ...
        long: int,
        toDoubleFunction: typing.Union[
            java.util.function.ToDoubleFunction[_ConcurrentHashMap__K],
    ...
    def reduceKeysToInt(
        ...
        long: int,
        toIntFunction: typing.Union[
            java.util.function.ToIntFunction[_ConcurrentHashMap__K],
    ...
    def reduceKeysToLong(
        ...
        long: int,
        toLongFunction: typing.Union[
            java.util.function.ToLongFunction[_ConcurrentHashMap__K],
            typing.Callable[[_ConcurrentHashMap__K], int],
        ],
        long2: int,
        longBinaryOperator: typing.Union[
    ...
    def reduceToDouble(
        self,
        long: int,
        toDoubleBiFunction: typing.Union[
    ...
    def reduceValues(
        ...
        long: int,
        function: typing.Union[
            java.util.function.Function[_ConcurrentHashMap__V, _reduceValues_1__U],
    ...
    def reduceValuesToDouble(
        ...
        long: int,
        toDoubleFunction: typing.Union[
            java.util.function.ToDoubleFunction[_ConcurrentHashMap__V],
    ...
    def reduceValuesToInt(
        ...
        long: int,
        toIntFunction: typing.Union[
            java.util.function.ToIntFunction[_ConcurrentHashMap__V],
    ...
    def reduceValuesToLong(
        ...
        long: int,
        toLongFunction: typing.Union[
            java.util.function.ToLongFunction[_ConcurrentHashMap__V],
            typing.Callable[[_ConcurrentHashMap__V], int],
        ],
        long2: int,
        longBinaryOperator: typing.Union[
    ...
    def searchKeys(
        ...
        long: int,
        function: typing.Union[
            java.util.function.Function[_ConcurrentHashMap__K, _searchKeys__U],
    ...
    def searchValues(
        ...
        long: int,
        function: typing.Union[
            java.util.function.Function[_ConcurrentHashMap__V, _searchValues__U],
    ...
    class KeySetView(
        ...
        def addAll(
            self,
            collection: typing.Union[
                java.util.Collection[_ConcurrentHashMap__KeySetView__K],
                typing.Sequence[_ConcurrentHashMap__KeySetView__K],
                typing.Set[_ConcurrentHashMap__KeySetView__K],
            ],
        ) -> bool: ...
        def contains(self, object: typing.Any) -> bool: ...
        def equals(self, object: typing.Any) -> bool: ...
        def forEach(
            self,
            consumer: typing.Union[
                java.util.function.Consumer[_ConcurrentHashMap__KeySetView__K],
...
class SubmissionPublisher(
    ...
    def consume(
        self,
        consumer: typing.Union[
            java.util.function.Consumer[_SubmissionPublisher__T],
