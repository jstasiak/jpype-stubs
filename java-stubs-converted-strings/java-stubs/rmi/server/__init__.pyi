...
class RMIClassLoader:
    ...
    @staticmethod
    def loadClass(
        string: str, string2: str, classLoader: java.lang.ClassLoader
...
class RMIClassLoaderSpi:
    ...
    def loadClass(
        self, string: str, string2: str, classLoader: java.lang.ClassLoader
    ) -> typing.Type[typing.Any]: ...
    def loadProxyClass(
        self,
        string: str,
...
class RemoteRef(java.io.Externalizable):
    ...
    def newCall(
        ...
        operationArray: typing.Union[typing.List[Operation], jpype.JArray],
        int: int,
        long: int,
    ) -> RemoteCall: ...
...
class RMISocketFactory(RMIClientSocketFactory, RMIServerSocketFactory):
    ...
    def setFailureHandler(
        rMIFailureHandler: typing.Union[RMIFailureHandler, typing.Callable],
    ) -> None: ...
    @staticmethod
...
class UnicastRemoteObject(RemoteServer):
    ...
    def exportObject(
        remote: java.rmi.Remote,
        int: int,
        objectInputFilter: typing.Union[java.io.ObjectInputFilter, typing.Callable],
    ) -> java.rmi.Remote: ...
    @typing.overload
    @staticmethod
    def exportObject(
        remote: java.rmi.Remote,
        int: int,
        rMIClientSocketFactory: typing.Union[RMIClientSocketFactory, typing.Callable],
        rMIServerSocketFactory: typing.Union[RMIServerSocketFactory, typing.Callable],
    ) -> java.rmi.Remote: ...
    @typing.overload
    @staticmethod
    def exportObject(
