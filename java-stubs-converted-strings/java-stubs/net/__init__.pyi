...
class Authenticator:
    ...
    @staticmethod
    def requestPasswordAuthentication(
        inetAddress: "InetAddress", int: int, string: str, string2: str, string3: str
    ) -> "PasswordAuthentication": ...
...
class ContentHandler:
    ...
    def getContent(
        ...
        classArray: typing.Union[typing.List[typing.Type], jpype.JArray],
    ) -> typing.Any: ...
...
class DatagramSocket(java.io.Closeable):
    ...
    def getOption(
        self, socketOption: "SocketOption"[_getOption__T]
    ) -> _getOption__T: ...
    def getPort(self) -> int: ...
    ...
    def setDatagramSocketImplFactory(
        datagramSocketImplFactory: typing.Union[
            "DatagramSocketImplFactory", typing.Callable
        ],
    ) -> None: ...
...
class InetAddress(java.io.Serializable):
    ...
    @staticmethod
    def getByAddress(
        string: str, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]
    ) -> "InetAddress": ...
    @staticmethod
...
class ServerSocket(java.io.Closeable):
    ...
    def setSocketFactory(
        socketImplFactory: typing.Union["SocketImplFactory", typing.Callable],
    ) -> None: ...
    def supportedOptions(self) -> java.util.Set["SocketOption"[typing.Any]]: ...
    def toString(self) -> str: ...
...
class URI(java.lang.Comparable["URI"], java.io.Serializable):
    ...
    @typing.overload
    def __init__(
        self, string: str, string2: str, string3: str, string4: str, string5: str
    ): ...
...
class URL(java.io.Serializable):
    ...
    @typing.overload
    def __init__(
        self, uRL: "URL", string: str, uRLStreamHandler: "URLStreamHandler"
    ): ...
    def equals(self, object: typing.Any) -> bool: ...
    def getAuthority(self) -> str: ...
    @typing.overload
    ...
    def setURLStreamHandlerFactory(
        uRLStreamHandlerFactory: typing.Union[
            "URLStreamHandlerFactory", typing.Callable
        ],
    ) -> None: ...
...
class URLClassLoader(java.security.SecureClassLoader, java.io.Closeable):
    ...
    def __init__(
        self,
        string: str,
        uRLArray: typing.Union[typing.List[URL], jpype.JArray],
...
class URLConnection:
    ...
    def setContentHandlerFactory(
        contentHandlerFactory: typing.Union[ContentHandlerFactory, typing.Callable],
    ) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def setFileNameMap(
        fileNameMap: typing.Union[FileNameMap, typing.Callable],
    ) -> None: ...
...
class CookieManager(CookieHandler):
    ...
    def __init__(
        ...
        cookiePolicy: typing.Union[CookiePolicy, typing.Callable],
    ): ...
    def get(
        self,
        uRI: URI,
    ...
    def setCookiePolicy(
        self, cookiePolicy: typing.Union[CookiePolicy, typing.Callable]
    ) -> None: ...
