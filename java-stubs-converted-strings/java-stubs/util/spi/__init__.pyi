...
class ResourceBundleProvider:
    def getBundle(
        self, string: str, locale: java.util.Locale
...
class CalendarNameProvider(LocaleServiceProvider):
    def getDisplayName(
        self, string: str, int: int, int2: int, int3: int, locale: java.util.Locale
    ) -> str: ...
    def getDisplayNames(
        self, string: str, int: int, int2: int, locale: java.util.Locale
    ) -> java.util.Map[str, int]: ...
...
class LocaleNameProvider(LocaleServiceProvider):
    ...
    def getDisplayUnicodeExtensionType(
        self, string: str, string2: str, locale: java.util.Locale
    ) -> str: ...
    def getDisplayVariant(self, string: str, locale: java.util.Locale) -> str: ...

class TimeZoneNameProvider(LocaleServiceProvider):
    def getDisplayName(
        self, string: str, boolean: bool, int: int, locale: java.util.Locale
    ) -> str: ...
    def getGenericDisplayName(
        self, string: str, int: int, locale: java.util.Locale
    ) -> str: ...
