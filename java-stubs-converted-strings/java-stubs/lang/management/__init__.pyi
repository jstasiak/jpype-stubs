...
class ManagementFactory:
    ...
    def getPlatformMXBean(
        class_: typing.Type[_getPlatformMXBean_0__T],
    ) -> _getPlatformMXBean_0__T: ...
    @typing.overload
    @staticmethod
    def getPlatformMXBean(
        mBeanServerConnection: javax.management.MBeanServerConnection,
        class_: typing.Type[_getPlatformMXBean_1__T],
    ...
    def newPlatformMXBeanProxy(
        mBeanServerConnection: javax.management.MBeanServerConnection,
        string: str,
        class_: typing.Type[_newPlatformMXBeanProxy__T],
...
class ThreadMXBean(PlatformManagedObject):
    ...
    @typing.overload
    def getThreadInfo(
        self, longArray: typing.Union[typing.List[int], jpype.JArray], int: int
    ) -> typing.MutableSequence[ThreadInfo]: ...
    @typing.overload
    def getThreadInfo(
        self,
