...
class AtomicIntegerFieldUpdater(typing.Generic[_AtomicIntegerFieldUpdater__T]):
    ...
    @staticmethod
    def newUpdater(
        class_: typing.Type[_newUpdater__U], string: typing.Union[java.lang.String, str]
...
class AtomicMarkableReference(typing.Generic[_AtomicMarkableReference__V]):
    ...
    def get(
        self, booleanArray: typing.Union[typing.List[bool], jpype.JArray]
...
class AtomicReference(java.io.Serializable, typing.Generic[_AtomicReference__V]):
    ...
    def accumulateAndGet(
        ...
        binaryOperator: typing.Union[
            java.util.function.BinaryOperator[_AtomicReference__V], typing.Callable
        ],
    ) -> _AtomicReference__V: ...
    ...
    def getAndUpdate(
        ...
        unaryOperator: typing.Union[
            java.util.function.UnaryOperator[_AtomicReference__V], typing.Callable
        ],
    ) -> _AtomicReference__V: ...
...
class AtomicReferenceArray(
    ...
    @typing.overload
    def __init__(
        self, eArray: typing.Union[typing.List[_AtomicReferenceArray__E], jpype.JArray]
    ): ...
    def accumulateAndGet(
        self,
        int: int,
        ...
        binaryOperator: typing.Union[
            java.util.function.BinaryOperator[_AtomicReferenceArray__E], typing.Callable
        ],
    ...
    def getAndUpdate(
        ...
        int: int,
        unaryOperator: typing.Union[
            java.util.function.UnaryOperator[_AtomicReferenceArray__E], typing.Callable
        ],
    ) -> _AtomicReferenceArray__E: ...
...
class AtomicReferenceFieldUpdater(
    ...
    def accumulateAndGet(
        ...
        binaryOperator: typing.Union[
            java.util.function.BinaryOperator[_AtomicReferenceFieldUpdater__V],
            typing.Callable,
        ],
    ) -> _AtomicReferenceFieldUpdater__V: ...
    def compareAndSet(
    ...
    def getAndUpdate(
        ...
        t: _AtomicReferenceFieldUpdater__T,
        unaryOperator: typing.Union[
            java.util.function.UnaryOperator[_AtomicReferenceFieldUpdater__V],
            typing.Callable,
        ],
    ) -> _AtomicReferenceFieldUpdater__V: ...
    def lazySet(
    ...
    @staticmethod
    def newUpdater(
        class_: typing.Type[_newUpdater__U],
        class2: typing.Type[_newUpdater__W],
