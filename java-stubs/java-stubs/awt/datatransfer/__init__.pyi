...
class SystemFlavorMap(FlavorMap, FlavorTable):
    def addFlavorForUnencodedNative(
        self, string: typing.Union[java.lang.String, str], dataFlavor: DataFlavor
    ) -> None: ...
    def addUnencodedNativeForFlavor(
        self, dataFlavor: DataFlavor, string: typing.Union[java.lang.String, str]
    ) -> None: ...
    @staticmethod
    def decodeDataFlavor(string: typing.Union[java.lang.String, str]) -> DataFlavor: ...
    @staticmethod
    def decodeJavaMIMEType(
        string: typing.Union[java.lang.String, str],
    ) -> java.lang.String: ...
    @staticmethod
    def encodeDataFlavor(dataFlavor: DataFlavor) -> java.lang.String: ...
    @staticmethod
    def encodeJavaMIMEType(
        string: typing.Union[java.lang.String, str],
    ) -> java.lang.String: ...
    @staticmethod
