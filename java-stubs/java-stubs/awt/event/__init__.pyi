...
class ActionEvent(java.awt.AWTEvent):
    ...
    @typing.overload
    def __init__(
        self, object: typing.Any, int: int, string: typing.Union[java.lang.String, str]
    ): ...
    @typing.overload
    def __init__(
        self,
...
class InvocationEvent(java.awt.AWTEvent, java.awt.ActiveEvent):
    ...
    def __init__(
        ...
        object: typing.Any,
        runnable: typing.Union[java.lang.Runnable, typing.Callable],
        runnable2: typing.Union[java.lang.Runnable, typing.Callable],
        boolean: bool,
    ): ...
...
class AWTEventListenerProxy(
    ...
    def __init__(
        self,
        long: int,
        aWTEventListener: typing.Union[AWTEventListener, typing.Callable],
    ): ...
    def eventDispatched(self, aWTEvent: java.awt.AWTEvent) -> None: ...
