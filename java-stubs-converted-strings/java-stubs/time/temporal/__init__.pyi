...
class TemporalAccessor:
    ...
    def query(
        ...
        temporalQuery: typing.Union[
            "TemporalQuery"[_query__R], typing.Callable[["TemporalAccessor"], _query__R]
        ],
    ) -> _query__R: ...
...
class TemporalAdjusters:
    ...
    def ofDateAdjuster(
        unaryOperator: typing.Union[
            java.util.function.UnaryOperator[java.time.LocalDate], typing.Callable
        ],
    ) -> TemporalAdjuster: ...
    @staticmethod
...
class TemporalField:
    ...
    def resolve(
        self,
        map: typing.Union[
            java.util.Map["TemporalField", int], typing.Mapping["TemporalField", int]
        ],
...
class Temporal(TemporalAccessor):
    ...
    @typing.overload
    def with_(
        self, temporalAdjuster: typing.Union[TemporalAdjuster, typing.Callable]
    ) -> "Temporal": ...
