...
class ConstantBootstraps:
    ...
    def enumConstant(
        lookup: "MethodHandles.Lookup",
        string: str,
        class_: typing.Type[_enumConstant__E],
    ) -> _enumConstant__E: ...
    @staticmethod
    def explicitCast(
        lookup: "MethodHandles.Lookup",
    ...
    def fieldVarHandle(
        ...
        class_: typing.Type["VarHandle"],
        class2: typing.Type[typing.Any],
        class3: typing.Type[typing.Any],
    ) -> "VarHandle": ...
    @typing.overload
    @staticmethod
    def getStaticFinal(
        lookup: "MethodHandles.Lookup", string: str, class_: typing.Type[typing.Any]
    ) -> typing.Any: ...
    @typing.overload
    @staticmethod
    def getStaticFinal(
...
class LambdaConversionException(java.lang.Exception):
    ...
    @typing.overload
    def __init__(
        self, string: str, throwable: java.lang.Throwable, boolean: bool, boolean2: bool
    ): ...
    @typing.overload
...
class MethodHandle(java.lang.constant.Constable):
    @typing.overload
    def asCollector(
        self, int: int, class_: typing.Type[typing.Any], int2: int
    ) -> "MethodHandle": ...
    @typing.overload
    def asCollector(
        self, class_: typing.Type[typing.Any], int: int
    ) -> "MethodHandle": ...
...
class MethodHandleInfo:
    ...
    def reflectAs(
        self, class_: typing.Type[_reflectAs__T], lookup: "MethodHandles.Lookup"
    ) -> _reflectAs__T: ...
    @staticmethod
    def toString(
        int: int, class_: typing.Type[typing.Any], string: str, methodType: "MethodType"
    ) -> str: ...
...
class MethodHandleProxies:
    ...
    def asInterfaceInstance(
        class_: typing.Type[_asInterfaceInstance__T], methodHandle: MethodHandle
...
class MethodHandles:
    ...
    def byteArrayViewVarHandle(
        class_: typing.Type[typing.Any], byteOrder: java.nio.ByteOrder
    ) -> "VarHandle": ...
    @staticmethod
    ...
    def catchException(
        methodHandle: MethodHandle,
        class_: typing.Type[java.lang.Throwable],
        methodHandle2: MethodHandle,
    ) -> MethodHandle: ...
    _classData__T = typing.TypeVar("_classData__T")  # <T>
    @staticmethod
    def classData(
        lookup: "MethodHandles.Lookup", string: str, class_: typing.Type[_classData__T]
    ) -> _classData__T: ...
    ...
    def classDataAt(
        lookup: "MethodHandles.Lookup",
        string: str,
        class_: typing.Type[_classDataAt__T],
        int: int,
    ) -> _classDataAt__T: ...
    @staticmethod
    ...
    @staticmethod
    def constant(
        class_: typing.Type[typing.Any], object: typing.Any
    ) -> MethodHandle: ...
    @typing.overload
    @staticmethod
    def countedLoop(
    ...
    @staticmethod
    def dropArguments(
        methodHandle: MethodHandle, int: int, *class_: typing.Type[typing.Any]
    ) -> MethodHandle: ...
    @typing.overload
    @staticmethod
    def dropArguments(
        methodHandle: MethodHandle,
        int: int,
        list: java.util.List[typing.Type[typing.Any]],
    ) -> MethodHandle: ...
    @staticmethod
    ...
    @staticmethod
    def dropCoordinates(
        varHandle: "VarHandle", int: int, *class_: typing.Type[typing.Any]
    ) -> "VarHandle": ...
    @staticmethod
    ...
    @staticmethod
    def loop(
        *methodHandleArray: typing.Union[typing.List[MethodHandle], jpype.JArray],
    ) -> MethodHandle: ...
    @staticmethod
    ...
    def permuteCoordinates(
        varHandle: "VarHandle", list: java.util.List[typing.Type[typing.Any]], *int: int
    ) -> "VarHandle": ...
    @staticmethod
    def privateLookupIn(
        class_: typing.Type[typing.Any], lookup: "MethodHandles.Lookup"
    ...
    @staticmethod
    def reflectAs(
        class_: typing.Type[_reflectAs__T], methodHandle: MethodHandle
    ) -> _reflectAs__T: ...
    @staticmethod
    ...
    @staticmethod
    def throwException(
        class_: typing.Type[typing.Any], class2: typing.Type[java.lang.Throwable]
    ) -> MethodHandle: ...
    @staticmethod
    def tryFinally(
        methodHandle: MethodHandle, methodHandle2: MethodHandle
    ...
    class Lookup:
        ...
        def accessClass(
            self, class_: typing.Type[_accessClass__T]
        ) -> typing.Type[_accessClass__T]: ...
        def bind(
            self, object: typing.Any, string: str, methodType: "MethodType"
        ) -> MethodHandle: ...
        def defineClass(
        ...
        def ensureInitialized(
            self, class_: typing.Type[_ensureInitialized__T]
        ) -> typing.Type[_ensureInitialized__T]: ...
        def findClass(self, string: str) -> typing.Type[typing.Any]: ...
        def findConstructor(
            self, class_: typing.Type[typing.Any], methodType: "MethodType"
        ) -> MethodHandle: ...
        def findGetter(
            self,
            class_: typing.Type[typing.Any],
        ...
        def findStatic(
            self, class_: typing.Type[typing.Any], string: str, methodType: "MethodType"
        ) -> MethodHandle: ...
        ...
        def unreflectSpecial(
            self, method: java.lang.reflect.Method, class_: typing.Type[typing.Any]
        ) -> MethodHandle: ...
...
class StringConcatFactory:
    @staticmethod
    def makeConcat(
        lookup: MethodHandles.Lookup, string: str, methodType: "MethodType"
    ) -> CallSite: ...
    @staticmethod
...
class SwitchPoint:
    ...
    @staticmethod
    def invalidateAll(
        switchPointArray: typing.Union[typing.List["SwitchPoint"], jpype.JArray],
    ) -> None: ...
...
class MutableCallSite(CallSite):
    ...
    @staticmethod
    def syncAll(
        mutableCallSiteArray: typing.Union[
            typing.List["MutableCallSite"], jpype.JArray
        ],
    ) -> None: ...
...
class MethodType(
    ...
    java.lang.invoke.TypeDescriptor.OfMethod[typing.Type[typing.Any], "MethodType"],
    ...
    @typing.overload
    def appendParameterTypes(
        self, list: java.util.List[typing.Type[typing.Any]]
    ) -> "MethodType": ...
    def changeParameterType(
        self, int: int, class_: typing.Type[typing.Any]
    ) -> "MethodType": ...
    ...
    def fromMethodDescriptorString(
        string: str, classLoader: java.lang.ClassLoader
    ) -> "MethodType": ...
    ...
    @typing.overload
    def insertParameterTypes(
        self, int: int, list: java.util.List[typing.Type[typing.Any]]
    ) -> "MethodType": ...
    ...
    @staticmethod
    def methodType(
        class_: typing.Type[typing.Any], class2: typing.Type[typing.Any]
    ) -> "MethodType": ...
    @typing.overload
    @staticmethod
    def methodType(
    ...
    def methodType(
        class_: typing.Type[typing.Any],
        classArray: typing.Union[typing.List[typing.Type[typing.Any]], jpype.JArray],
    ) -> "MethodType": ...
    @typing.overload
    @staticmethod
    def methodType(
        class_: typing.Type[typing.Any], methodType: "MethodType"
    ) -> "MethodType": ...
    @typing.overload
    @staticmethod
    def methodType(
        class_: typing.Type[typing.Any], list: java.util.List[typing.Type[typing.Any]]
    ) -> "MethodType": ...
