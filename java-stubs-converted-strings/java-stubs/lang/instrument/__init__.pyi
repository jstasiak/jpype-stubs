...
class Instrumentation:
    ...
    ) -> typing.MutableSequence[typing.Type]: ...
    ...
    def redefineModule(
        ...
        map: typing.Union[
            java.util.Map[str, java.util.Set[java.lang.Module]],
            typing.Mapping[str, java.util.Set[java.lang.Module]],
        ],
        map2: typing.Union[
            java.util.Map[str, java.util.Set[java.lang.Module]],
            typing.Mapping[str, java.util.Set[java.lang.Module]],
        ],
        set2: java.util.Set[typing.Type[typing.Any]],
        map3: typing.Union[
            java.util.Map[
                typing.Type[typing.Any], java.util.List[typing.Type[typing.Any]]
            ],
            typing.Mapping[
                typing.Type[typing.Any], java.util.List[typing.Type[typing.Any]]
            ],
    ...
    def setNativeMethodPrefix(
        self, classFileTransformer: ClassFileTransformer, string: str
    ) -> None: ...
