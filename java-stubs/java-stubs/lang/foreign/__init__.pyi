...
class MemorySegment:
    ...
    @typing.overload
    def getAtIndex(
        self, addressLayout: "AddressLayout", long: int
    ) -> "MemorySegment": ...
    @typing.overload
    ...
    @typing.overload
    def setAtIndex(
        self, ofByte: "ValueLayout.OfByte", long: int, byte: int
    ) -> None: ...
    @typing.overload
    def setAtIndex(
        self, ofChar: "ValueLayout.OfChar", long: int, char: str
    ) -> None: ...
    @typing.overload
    def setAtIndex(
        self, ofDouble: "ValueLayout.OfDouble", long: int, double: float
    ...
    @typing.overload
    def setAtIndex(
        self, ofLong: "ValueLayout.OfLong", long: int, long2: int
    ) -> None: ...
    @typing.overload
    def setAtIndex(
    ...
    @typing.overload
    def toArray(
        self, ofShort: "ValueLayout.OfShort"
...
class SegmentAllocator:
    ...
    @typing.overload
    def allocateFrom(
        self, ofByte: "ValueLayout.OfByte", byte: int
    ) -> MemorySegment: ...
    @typing.overload
    def allocateFrom(
        self, ofByte: "ValueLayout.OfByte", *byte: int
    ...
    @typing.overload
    def allocateFrom(
        self, ofChar: "ValueLayout.OfChar", char: str
    ) -> MemorySegment: ...
    @typing.overload
    def allocateFrom(
        self, ofChar: "ValueLayout.OfChar", *char: str
    ...
    @typing.overload
    def allocateFrom(
        self, ofLong: "ValueLayout.OfLong", long: int
    ) -> MemorySegment: ...
    @typing.overload
    def allocateFrom(
        self, ofLong: "ValueLayout.OfLong", *long: int
...
class SymbolLookup:
    ...
    @staticmethod
    def libraryLookup(
        string: typing.Union[java.lang.String, str], arena: "Arena"
    ) -> "SymbolLookup": ...
    @typing.overload
    @staticmethod
    def libraryLookup(
    ...
    def or_(
        self, symbolLookup: typing.Union["SymbolLookup", typing.Callable]
    ) -> "SymbolLookup": ...
...
class ValueLayout(MemoryLayout):
    ...
    class OfBoolean(java.lang.foreign.ValueLayout):
        ...
        def withOrder(
            self, byteOrder: java.nio.ByteOrder
        ) -> "ValueLayout.OfBoolean": ...
