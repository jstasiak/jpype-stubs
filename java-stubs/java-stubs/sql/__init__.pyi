...
class Array:
    ...
    def getArray(
        self,
        map: typing.Union[
            java.util.Map[typing.Union[java.lang.String, str], typing.Type[typing.Any]],
            typing.Mapping[
                typing.Union[java.lang.String, str], typing.Type[typing.Any]
            ],
        ],
    ) -> typing.Any: ...
    @typing.overload
...
class Blob:
    ...
    @typing.overload
    def position(
        self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes], long: int
    ) -> int: ...
    @typing.overload
    ...
    @typing.overload
    def setBytes(
        self, long: int, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]
    ) -> int: ...
    @typing.overload
    def setBytes(
        self,
...
class Clob:
    ...
    @typing.overload
    def position(
        self, string: typing.Union[java.lang.String, str], long: int
    ) -> int: ...
    @typing.overload
    ...
    @typing.overload
    def setString(
        self, long: int, string: typing.Union[java.lang.String, str]
    ) -> int: ...
    @typing.overload
    def setString(
        self,
...
class DriverManager:
    ...
    @staticmethod
    def getConnection(
        string: typing.Union[java.lang.String, str], properties: java.util.Properties
    ) -> "Connection": ...
    @staticmethod
    ...
    @staticmethod
    def registerDriver(
        driver: Driver, driverAction: typing.Union[DriverAction, typing.Callable]
    ) -> None: ...
    @staticmethod
...
class SQLData:
    ...
    def readSQL(
        self, sQLInput: "SQLInput", string: typing.Union[java.lang.String, str]
    ) -> None: ...
...
class SQLOutput:
    ...
    def writeBigDecimal(
        self, bigDecimal: typing.Union[java.math.BigDecimal, decimal.Decimal]
    ) -> None: ...
    ...
    def writeTimestamp(
        self, timestamp: typing.Union["Timestamp", datetime.datetime]
    ) -> None: ...
...
class Connection(Wrapper, java.lang.AutoCloseable):
    ...
    def getTypeMap(
        self,
    ) -> java.util.Map[java.lang.String, typing.Type[typing.Any]]: ...
    ...
    def setNetworkTimeout(
        self,
        executor: typing.Union[java.util.concurrent.Executor, typing.Callable],
        int: int,
    ) -> None: ...
...
class ResultSet(Wrapper, java.lang.AutoCloseable):
    ...
    @typing.overload
    def getDate(
        self, string: typing.Union[java.lang.String, str], calendar: java.util.Calendar
    ) -> Date: ...
    @typing.overload
    ...
    @typing.overload
    def getObject(
        self, int: int, class_: typing.Type[_getObject_1__T]
    ) -> _getObject_1__T: ...
    @typing.overload
    def getObject(
        self,
    ...
    def getObject(
        self,
        string: typing.Union[java.lang.String, str],
        class_: typing.Type[_getObject_4__T],
    ) -> _getObject_4__T: ...
    @typing.overload
    def getObject(
        self,
    ...
    @typing.overload
    def updateArray(
        self, string: typing.Union[java.lang.String, str], array: Array
    ) -> None: ...
    @typing.overload
    ...
    def updateBigDecimal(
        self, int: int, bigDecimal: typing.Union[java.math.BigDecimal, decimal.Decimal]
    ) -> None: ...
    @typing.overload
    def updateBigDecimal(
        self,
        string: typing.Union[java.lang.String, str],
        bigDecimal: typing.Union[java.math.BigDecimal, decimal.Decimal],
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def updateBlob(
        self, string: typing.Union[java.lang.String, str], blob: Blob
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def updateByte(
        self, string: typing.Union[java.lang.String, str], byte: int
    ) -> None: ...
    @typing.overload
    def updateBytes(
    ...
    @typing.overload
    def updateCharacterStream(
        self, string: typing.Union[java.lang.String, str], reader: java.io.Reader
    ) -> None: ...
    @typing.overload
    def updateCharacterStream(
        self,
    ...
    @typing.overload
    def updateClob(
        self, string: typing.Union[java.lang.String, str], clob: Clob
    ) -> None: ...
    @typing.overload
    ...
    def updateDate(
        self,
        string: typing.Union[java.lang.String, str],
        date: typing.Union[Date, datetime.date],
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def updateFloat(
        self, string: typing.Union[java.lang.String, str], float: float
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def updateNClob(
        self, string: typing.Union[java.lang.String, str], nClob: NClob
    ) -> None: ...
    @typing.overload
    def updateNString(
    ...
    @typing.overload
    def updateObject(
        self, string: typing.Union[java.lang.String, str], object: typing.Any, int: int
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def updateRef(
        self, string: typing.Union[java.lang.String, str], ref: Ref
    ) -> None: ...
    def updateRow(self) -> None: ...
    @typing.overload
    def updateRowId(
        self, int: int, rowId: typing.Union[RowId, typing.Callable]
    ) -> None: ...
    @typing.overload
    def updateRowId(
        self,
        string: typing.Union[java.lang.String, str],
        rowId: typing.Union[RowId, typing.Callable],
    ) -> None: ...
    @typing.overload
    def updateSQLXML(self, int: int, sQLXML: SQLXML) -> None: ...
    @typing.overload
    def updateSQLXML(
        self, string: typing.Union[java.lang.String, str], sQLXML: SQLXML
    ) -> None: ...
    @typing.overload
    def updateShort(self, int: int, short: int) -> None: ...
    @typing.overload
    def updateShort(
        self, string: typing.Union[java.lang.String, str], short: int
    ) -> None: ...
    @typing.overload
    def updateString(
        self, int: int, string: typing.Union[java.lang.String, str]
    ...
    def updateTime(
        self,
        string: typing.Union[java.lang.String, str],
        time: typing.Union[Time, datetime.time],
    ) -> None: ...
    @typing.overload
    def updateTimestamp(
        self, int: int, timestamp: typing.Union[Timestamp, datetime.datetime]
    ) -> None: ...
    @typing.overload
    def updateTimestamp(
        self,
        string: typing.Union[java.lang.String, str],
        timestamp: typing.Union[Timestamp, datetime.datetime],
    ) -> None: ...
    def wasNull(self) -> bool: ...
...
class SQLClientInfoException(SQLException):
    ...
    def __init__(
        ...
        int: int,
        map: typing.Union[
            java.util.Map[typing.Union[java.lang.String, str], ClientInfoStatus],
            typing.Mapping[typing.Union[java.lang.String, str], ClientInfoStatus],
        ],
    ): ...
    @typing.overload
    def __init__(
...
class CallableStatement(PreparedStatement):
    ...
    @typing.overload
    def registerOutParameter(
        self, int: int, sQLType: SQLType, string: typing.Union[java.lang.String, str]
    ) -> None: ...
    @typing.overload
    def registerOutParameter(
        self, string: typing.Union[java.lang.String, str], sQLType: SQLType
    ) -> None: ...
    @typing.overload
    def registerOutParameter(
        self, string: typing.Union[java.lang.String, str], sQLType: SQLType, int: int
    ) -> None: ...
    @typing.overload
    def registerOutParameter(
        self,
    ...
    @typing.overload
    def setURL(
        self, string: typing.Union[java.lang.String, str], uRL: java.net.URL
    ) -> None: ...
    @typing.overload
    def setURL(self, int: int, uRL: java.net.URL) -> None: ...
    def wasNull(self) -> bool: ...
...
class __module_protocol__(Protocol):
    ...
    SQLIntegrityConstraintViolationException: typing.Type[
        SQLIntegrityConstraintViolationException
    ]
    SQLInvalidAuthorizationSpecException: typing.Type[
