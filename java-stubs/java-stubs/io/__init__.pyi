...
class FileFilter:
    def accept(
        self, file: typing.Union["File", jpype.protocol.SupportsPath]
    ) -> bool: ...

class FilenameFilter:
    def accept(
        self,
        file: typing.Union["File", jpype.protocol.SupportsPath],
...
class ObjectInputFilter:
    ...
    def allowFilter(
        predicate: typing.Union[
            java.util.function.Predicate[typing.Type[typing.Any]],
            typing.Callable[[typing.Type[typing.Any]], bool],
        ],
    ...
    @staticmethod
    def merge(
        objectInputFilter: typing.Union["ObjectInputFilter", typing.Callable],
        objectInputFilter2: typing.Union["ObjectInputFilter", typing.Callable],
    ) -> "ObjectInputFilter": ...
    @staticmethod
    def rejectFilter(
        predicate: typing.Union[
        ...
        def setSerialFilterFactory(
            binaryOperator: typing.Union[
                java.util.function.BinaryOperator[
                    typing.Union["ObjectInputFilter", typing.Callable]
                ],
                typing.Callable,
            ],
        ) -> None: ...
...
class UncheckedIOException(java.lang.RuntimeException):
    ...
    @typing.overload
    def __init__(
        self, string: typing.Union[java.lang.String, str], iOException: IOException
    ): ...
...
class File(Serializable, java.lang.Comparable["File"]):
    ...
    @typing.overload
    def list(
        self, filenameFilter: typing.Union[FilenameFilter, typing.Callable]
    ) -> typing.MutableSequence[java.lang.String]: ...
    @typing.overload
    def listFiles(self) -> typing.MutableSequence["File"]: ...
    @typing.overload
    def listFiles(
        self, fileFilter: typing.Union[FileFilter, typing.Callable]
...
class FileOutputStream(OutputStream):
    ...
    @typing.overload
    def __init__(
        self, file: typing.Union[File, jpype.protocol.SupportsPath], boolean: bool
    ): ...
    @typing.overload
    def __init__(self, fileDescriptor: FileDescriptor): ...
    @typing.overload
...
class InputStreamReader(Reader):
    ...
    @typing.overload
    def __init__(
        self, inputStream: InputStream, string: typing.Union[java.lang.String, str]
    ): ...
    @typing.overload
...
class ObjectInputStream(InputStream, ObjectInput, ObjectStreamConstants):
    ...
    def registerValidation(
        self,
        objectInputValidation: typing.Union[ObjectInputValidation, typing.Callable],
        int: int,
    ) -> None: ...
    def setObjectInputFilter(
        self, objectInputFilter: typing.Union[ObjectInputFilter, typing.Callable]
    ) -> None: ...
    def skipBytes(self, int: int) -> int: ...
    class GetField:
        def __init__(self): ...
        ...
        @typing.overload
        def get(
            self, string: typing.Union[java.lang.String, str], char: str
        ) -> str: ...
        @typing.overload
        def get(
...
class OutputStreamWriter(Writer):
    ...
    @typing.overload
    def __init__(
        self, outputStream: OutputStream, string: typing.Union[java.lang.String, str]
    ): ...
    @typing.overload
    def __init__(
