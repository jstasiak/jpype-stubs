...
class CertPathBuilder:
    def build(
        self, certPathParameters: typing.Union["CertPathParameters", typing.Callable]
    ...
    @staticmethod
    def getInstance(
        string: str, provider: java.security.Provider
    ) -> "CertPathBuilder": ...
...
class CertPathValidator:
    ...
    def validate(
        self,
        certPath: CertPath,
        certPathParameters: typing.Union[CertPathParameters, typing.Callable],
...
class CertStore:
    ...
    def getInstance(
        string: str,
        certStoreParameters: typing.Union["CertStoreParameters", typing.Callable],
    ) -> "CertStore": ...
    @typing.overload
    @staticmethod
    def getInstance(
...
class CertStoreSpi:
    def __init__(
        self, certStoreParameters: typing.Union[CertStoreParameters, typing.Callable]
    ): ...
...
class CertificateFactory:
    ...
    def generateCertPath(
        self, inputStream: java.io.InputStream, string: str
    ) -> CertPath: ...
    @typing.overload
...
class CertificateRevokedException(CertificateException):
    def __init__(
        ...
        x500Principal: javax.security.auth.x500.X500Principal,
        map: typing.Union[
            java.util.Map[str, Extension], typing.Mapping[str, Extension]
        ],
    ): ...
...
class PKIXCertPathChecker(CertPathChecker, java.lang.Cloneable):
    ...
    def check(
        ...
        collection: typing.Union[
            java.util.Collection[str], typing.Sequence[str], typing.Set[str]
        ],
    ) -> None: ...
    @typing.overload
    def check(self, certificate: Certificate) -> None: ...
...
class X509CRLSelector(CRLSelector):
    ...
    def setIssuers(
        ...
        collection: typing.Union[
            ...
            typing.Set[javax.security.auth.x500.X500Principal],
        ],
    ) -> None: ...
...
class X509CertSelector(CertSelector):
    ...
    def setPathToNames(
        ...
        collection: typing.Union[
            ...
            typing.Set[java.util.List[typing.Any]],
        ],
    ) -> None: ...
...
class PKIXRevocationChecker(PKIXCertPathChecker):
    ...
    def setOcspResponses(
        ...
        map: typing.Union[
            java.util.Map[
                X509Certificate, typing.Union[typing.List[int], jpype.JArray, bytes]
            ],
            typing.Mapping[
                X509Certificate, typing.Union[typing.List[int], jpype.JArray, bytes]
            ],
    ...
    def setOptions(
        self, set: java.util.Set["PKIXRevocationChecker.Option"]
    ) -> None: ...
...
class CertPathValidatorException(java.security.GeneralSecurityException):
    ...
    @typing.overload
    def __init__(
        self, string: str, throwable: java.lang.Throwable, certPath: CertPath, int: int
    ): ...
    @typing.overload
    def __init__(
        self,
    ...
    class BasicReason(
        ...
        INVALID_SIGNATURE: typing.ClassVar[
            "CertPathValidatorException.BasicReason"
        ] = ...
