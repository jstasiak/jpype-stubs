...
class AsynchronousChannelGroup:
    ...
    def withFixedThreadPool(
        int: int,
        threadFactory: typing.Union[
            java.util.concurrent.ThreadFactory, typing.Callable
        ],
    ) -> "AsynchronousChannelGroup": ...
    @staticmethod
    def withThreadPool(
...
class Channels:
    ...
    @staticmethod
    def newReader(
        readableByteChannel: "ReadableByteChannel", string: str
    ) -> java.io.Reader: ...
    @typing.overload
    @staticmethod
    def newReader(
    ...
    @staticmethod
    def newWriter(
        writableByteChannel: "WritableByteChannel", string: str
    ) -> java.io.Writer: ...
    @typing.overload
    @staticmethod
    def newWriter(
...
class Selector(java.io.Closeable):
    ...
    def select(
        ...
        consumer: typing.Union[
            java.util.function.Consumer[SelectionKey],
...
class GatheringByteChannel(WritableByteChannel):
    ...
    def write(
        self,
        byteBufferArray: typing.Union[typing.List[java.nio.ByteBuffer], jpype.JArray],
    ) -> int: ...
    @typing.overload
    def write(
        self,
...
class ServerSocketChannel(
    ...
    @staticmethod
    def open(
        protocolFamily: typing.Union[java.net.ProtocolFamily, typing.Callable],
    ) -> "ServerSocketChannel": ...
    _setOption__T = typing.TypeVar("_setOption__T")  # <T>
    def setOption(
        self, socketOption: java.net.SocketOption[_setOption__T], t: _setOption__T
