...
class Class(
    ...
    @staticmethod
    def forName(
        string: str, boolean: bool, classLoader: "ClassLoader"
    ...
    def getDeclaredMethod(
        self, string: str, *class_: typing.Type[typing.Any]
...
class ModuleLayer:
    ...
    def defineModules(
        ...
        function: typing.Union[
            java.util.function.Function[str, ClassLoader],
            typing.Callable[[str], ClassLoader],
        ],
    ) -> "ModuleLayer": ...
    @typing.overload
    @staticmethod
    ...
    class Controller:
        def addExports(
            self, module: Module, string: str, module2: Module
        ) -> "ModuleLayer.Controller": ...
        def addOpens(
            self, module: Module, string: str, module2: Module
        ) -> "ModuleLayer.Controller": ...
...
class Enum(
    ...
    class EnumDesc(
        ...
        @staticmethod
        def of(
            classDesc: java.lang.constant.ClassDesc, string: str
...
class Runtime(_JRuntime):
    ...
    @typing.overload
    def exec_(
        self, string: str, stringArray: typing.Union[typing.List[str], jpype.JArray]
    ) -> Process: ...
    @typing.overload
    def exec_(
        self,
        string: str,
        stringArray: typing.Union[typing.List[str], jpype.JArray],
        file: typing.Union[java.io.File, jpype.protocol.SupportsPath],
    ) -> Process: ...
    @typing.overload
    def exec_(
        self, stringArray: typing.Union[typing.List[str], jpype.JArray]
    ) -> Process: ...
    @typing.overload
    def exec_(
        self,
        stringArray: typing.Union[typing.List[str], jpype.JArray],
        stringArray2: typing.Union[typing.List[str], jpype.JArray],
    ) -> Process: ...
    @typing.overload
    def exec_(
        self,
...
class String(
    ...
    @typing.overload
    def regionMatches(
        self, boolean: bool, int: int, string: str, int2: int, int3: int
    ) -> bool: ...
    @typing.overload
    ...
    def transform(
        self,
        function: typing.Union[
            java.util.function.Function[str, _transform__R],
            typing.Callable[[str], _transform__R],
        ],
    ) -> _transform__R: ...
...
class System:
    ...
    @staticmethod
    def getLogger(
        string: str, resourceBundle: java.util.ResourceBundle
    ) -> "System.Logger": ...
    @staticmethod
    ...
    class Logger:
        ...
        @typing.overload
        def log(
            self, level: "System.Logger.Level", string: str, *object: typing.Any
        ) -> None: ...
        @typing.overload
        def log(
            self, level: "System.Logger.Level", string: str, throwable: Throwable
        ) -> None: ...
        @typing.overload
        def log(
            self,
    ...
    class LoggerFinder:
        def getLocalizedLogger(
            self, string: str, resourceBundle: java.util.ResourceBundle, module: Module
        ) -> "System.Logger": ...
...
class Thread(Runnable, _JThread):
    ...
    @typing.overload
    def __init__(
        self, runnable: typing.Union[Runnable, typing.Callable], string: str
    ): ...
    @typing.overload
    def __init__(self, string: str): ...
    @typing.overload
