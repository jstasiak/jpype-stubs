...
class Clipboard:
    ...
    def addFlavorListener(
        self, flavorListener: typing.Union["FlavorListener", typing.Callable]
    ) -> None: ...
    ...
    def setContents(
        ...
        clipboardOwner: typing.Union["ClipboardOwner", typing.Callable],
    ) -> None: ...
...
class DataFlavor(java.io.Externalizable, java.lang.Cloneable):
    ...
    def selectBestTextFlavor(
        dataFlavorArray: typing.Union[typing.List["DataFlavor"], jpype.JArray],
    ) -> "DataFlavor": ...
...
class FlavorMap:
    ...
    ) -> java.util.Map[str, DataFlavor]: ...
    def getNativesForFlavors(
        self, dataFlavorArray: typing.Union[typing.List[DataFlavor], jpype.JArray]
    ) -> java.util.Map[DataFlavor, str]: ...
...
class SystemFlavorMap(FlavorMap, FlavorTable):
    def addFlavorForUnencodedNative(
        self, string: str, dataFlavor: DataFlavor
    ) -> None: ...
    def addUnencodedNativeForFlavor(
        self, dataFlavor: DataFlavor, string: str
    ) -> None: ...
    @staticmethod
