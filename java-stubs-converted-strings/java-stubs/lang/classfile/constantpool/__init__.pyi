...
class ConstantPool(java.lang.Iterable["PoolEntry"]):
    ...
    @typing.overload
    def entryByIndex(
        self, int: int, class_: typing.Type[_entryByIndex_1__T]
    ) -> _entryByIndex_1__T: ...
...
class ConstantPoolBuilder(ConstantPool):
    ...
    @typing.overload
    def nameAndTypeEntry(
        self, string: str, classDesc: java.lang.constant.ClassDesc
    ) -> "NameAndTypeEntry": ...
    @typing.overload
    def nameAndTypeEntry(
        self, string: str, methodTypeDesc: java.lang.constant.MethodTypeDesc
    ) -> "NameAndTypeEntry": ...
    @typing.overload
    @staticmethod
