...
class ModuleDescriptor(java.lang.Comparable["ModuleDescriptor"]):
    ...
    @staticmethod
    def newModule(
        string: str, set: java.util.Set["ModuleDescriptor.Modifier"]
    ...
    def read(
        ...
        supplier: typing.Union[
            java.util.function.Supplier[java.util.Set[str]],
            typing.Callable[[], java.util.Set[str]],
        ],
    ) -> "ModuleDescriptor": ...
    @typing.overload
    @staticmethod
    ...
    class Builder:
        ...
        @typing.overload
        def exports(
            self, string: str, set: java.util.Set[str]
        ) -> "ModuleDescriptor.Builder": ...
        @typing.overload
        def exports(
        ...
        @typing.overload
        def exports(
            self, set: java.util.Set["ModuleDescriptor.Exports.Modifier"], string: str
        ) -> "ModuleDescriptor.Builder": ...
        @typing.overload
        def exports(
            self,
        ...
        @typing.overload
        def opens(
            self, opens: "ModuleDescriptor.Opens"
        ) -> "ModuleDescriptor.Builder": ...
        @typing.overload
        def opens(
            self, set: java.util.Set["ModuleDescriptor.Opens.Modifier"], string: str
        ) -> "ModuleDescriptor.Builder": ...
        @typing.overload
        def opens(
            self,
        ...
        @typing.overload
        def provides(
            self, string: str, list: java.util.List[str]
        ) -> "ModuleDescriptor.Builder": ...
        @typing.overload
        def provides(
        ...
        @typing.overload
        def requires(
            self, set: java.util.Set["ModuleDescriptor.Requires.Modifier"], string: str
        ) -> "ModuleDescriptor.Builder": ...
        @typing.overload
        def requires(
            self,
