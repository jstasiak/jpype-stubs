...
class ColorModel(java.awt.Transparency):
    ...
    @typing.overload
    def getDataElement(
        self, floatArray: typing.Union[typing.List[float], jpype.JArray], int: int
    ) -> int: ...
    @typing.overload
    def getDataElement(
...
class Kernel(java.lang.Cloneable):
    ...
    def getKernelData(
        self, floatArray: typing.Union[typing.List[float], jpype.JArray]
    ) -> typing.MutableSequence[float]: ...
...
class VolatileImage(java.awt.Image, java.awt.Transparency):
    ...
    @typing.overload
    def getHeight(
        self, imageObserver: typing.Union[ImageObserver, typing.Callable]
    ) -> int: ...
    @typing.overload
    def getHeight(self) -> int: ...
...
class AbstractMultiResolutionImage(java.awt.Image, MultiResolutionImage):
    ...
    def getProperty(
        self, string: str, imageObserver: typing.Union[ImageObserver, typing.Callable]
    ) -> typing.Any: ...
    def getSource(self) -> ImageProducer: ...
    def getWidth(
        self, imageObserver: typing.Union[ImageObserver, typing.Callable]
...
class ByteLookupTable(LookupTable):
    @typing.overload
    def __init__(
        self, int: int, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]
    ): ...
    @typing.overload
    def __init__(
        self,
        int: int,
        byteArray: typing.Union[typing.List[typing.MutableSequence[int]], jpype.JArray],
    ): ...
...
class ColorConvertOp(BufferedImageOp, RasterOp):
    ...
    def __init__(
        self,
        iCC_ProfileArray: typing.Union[
            typing.List[java.awt.color.ICC_Profile], jpype.JArray
        ],
        renderingHints: java.awt.RenderingHints,
    ): ...
    def createCompatibleDestImage(
...
class DataBufferByte(DataBuffer):
    @typing.overload
    def __init__(
        self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes], int: int
    ): ...
    @typing.overload
    def __init__(
        self,
...
class DataBufferInt(DataBuffer):
    ...
    def __init__(
        self,
        intArray: typing.Union[typing.List[typing.MutableSequence[int]], jpype.JArray],
        int2: int,
    ): ...
    @typing.overload
    def __init__(
...
class DataBufferShort(DataBuffer):
    ...
    @typing.overload
    def __init__(
        self, shortArray: typing.Union[typing.List[int], jpype.JArray], int: int
    ): ...
    @typing.overload
    def __init__(
        self,
    ...
    def __init__(
        self,
        shortArray: typing.Union[
            typing.List[typing.MutableSequence[int]], jpype.JArray
        ],
        int: int,
    ): ...
    @typing.overload
...
class IndexColorModel(ColorModel):
    ...
    def __init__(
        ...
        byteArray: typing.Union[typing.List[int], jpype.JArray, bytes],
        byteArray2: typing.Union[typing.List[int], jpype.JArray, bytes],
        byteArray3: typing.Union[typing.List[int], jpype.JArray, bytes],
    ): ...
    @typing.overload
    def __init__(
        self,
        ...
        byteArray2: typing.Union[typing.List[int], jpype.JArray, bytes],
        byteArray3: typing.Union[typing.List[int], jpype.JArray, bytes],
        byteArray4: typing.Union[typing.List[int], jpype.JArray, bytes],
    ): ...
    @typing.overload
    def __init__(
        self,
    ...
    def convertToIntDiscrete(
        self, raster: Raster, boolean: bool
    ) -> "BufferedImage": ...
    def createCompatibleSampleModel(self, int: int, int2: int) -> SampleModel: ...
    def createCompatibleWritableRaster(
        self, int: int, int2: int
...
class ShortLookupTable(LookupTable):
    @typing.overload
    def __init__(
        self, int: int, shortArray: typing.Union[typing.List[int], jpype.JArray]
    ): ...
    @typing.overload
    def __init__(
        self,
...
class WritableRaster(Raster):
    ...
    def createWritableTranslatedChild(
        self, int: int, int2: int
    ) -> "WritableRaster": ...
...
class WritableRenderedImage(RenderedImage):
    def addTileObserver(
        self, tileObserver: typing.Union[TileObserver, typing.Callable]
    ) -> None: ...
