...
class FilenameFilter:
    def accept(
        self, file: typing.Union["File", jpype.protocol.SupportsPath], string: str
    ) -> bool: ...
...
class Console(Flushable):
    ...
    @typing.overload
    def format(
        self, locale: java.util.Locale, string: str, *object: typing.Any
    ) -> "Console": ...
    ...
    @typing.overload
    def readPassword(
        self, string: str, *object: typing.Any
...
class FileWriter(OutputStreamWriter):
    ...
    @typing.overload
    def __init__(
        self, string: str, charset: java.nio.charset.Charset, boolean: bool
    ): ...
