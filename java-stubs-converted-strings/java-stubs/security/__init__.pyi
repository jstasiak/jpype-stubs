...
class AccessControlContext:
    ...
    def __init__(
        ...
        domainCombiner: typing.Union["DomainCombiner", typing.Callable],
    ): ...
    @typing.overload
    def __init__(
        self,
        protectionDomainArray: typing.Union[
            typing.List["ProtectionDomain"], jpype.JArray
        ],
    ): ...
...
class AccessController:
    ...
    def doPrivileged(
        privilegedAction: typing.Union[
            "PrivilegedAction"[_doPrivileged_0__T],
    ...
    def doPrivileged(
        privilegedAction: typing.Union[
            "PrivilegedAction"[_doPrivileged_1__T],
    ...
    def doPrivileged(
        privilegedAction: typing.Union[
            "PrivilegedAction"[_doPrivileged_2__T],
    ...
    def doPrivileged(
        privilegedExceptionAction: typing.Union[
            "PrivilegedExceptionAction"[_doPrivileged_3__T],
    ...
    def doPrivileged(
        privilegedExceptionAction: typing.Union[
            "PrivilegedExceptionAction"[_doPrivileged_4__T],
    ...
    def doPrivileged(
        privilegedExceptionAction: typing.Union[
            "PrivilegedExceptionAction"[_doPrivileged_5__T],
    ...
    def doPrivilegedWithCombiner(
        privilegedAction: typing.Union[
            "PrivilegedAction"[_doPrivilegedWithCombiner_0__T],
    ...
    def doPrivilegedWithCombiner(
        privilegedAction: typing.Union[
            "PrivilegedAction"[_doPrivilegedWithCombiner_1__T],
    ...
    def doPrivilegedWithCombiner(
        privilegedExceptionAction: typing.Union[
            "PrivilegedExceptionAction"[_doPrivilegedWithCombiner_2__T],
    ...
    def doPrivilegedWithCombiner(
        privilegedExceptionAction: typing.Union[
            "PrivilegedExceptionAction"[_doPrivilegedWithCombiner_3__T],
...
class AlgorithmParameters:
    ...
    def getParameterSpec(
        self, class_: typing.Type[_getParameterSpec__T]
...
class CodeSigner(java.io.Serializable):
    def __init__(
        self, certPath: java.security.cert.CertPath, timestamp: "Timestamp"
    ): ...
    def equals(self, object: typing.Any) -> bool: ...
...
class CodeSource(java.io.Serializable):
    ...
    def __init__(
        self,
        uRL: java.net.URL,
        codeSignerArray: typing.Union[typing.List[CodeSigner], jpype.JArray],
    ): ...
    @typing.overload
    def __init__(
        self,
        uRL: java.net.URL,
        certificateArray: typing.Union[
            typing.List[java.security.cert.Certificate], jpype.JArray
        ],
    ): ...
    def equals(self, object: typing.Any) -> bool: ...
    def getCertificates(
...
class DomainCombiner:
    def combine(
        ...
        protectionDomainArray2: typing.Union[
            typing.List["ProtectionDomain"], jpype.JArray
        ],
...
class GuardedObject(java.io.Serializable):
    def __init__(
        self, object: typing.Any, guard: typing.Union[Guard, typing.Callable]
    ): ...
...
class KeyFactory:
    ...
    def getKeySpec(
        self, key: Key, class_: typing.Type[_getKeySpec__T]
    ) -> _getKeySpec__T: ...
    def getProvider(self) -> "Provider": ...
...
class KeyStoreSpi:
    ...
    def engineEntryInstanceOf(
        self, string: str, class_: typing.Type["KeyStore.Entry"]
    ) -> bool: ...
    ...
    def engineGetEntry(
        self, string: str, protectionParameter: "KeyStore.ProtectionParameter"
    ) -> "KeyStore.Entry": ...
    def engineGetKey(
        self, string: str, charArray: typing.Union[typing.List[str], jpype.JArray]
    ) -> Key: ...
    ...
    def engineLoad(
        self,
        loadStoreParameter: typing.Union[
            "KeyStore.LoadStoreParameter", typing.Callable
        ],
    ) -> None: ...
    def engineProbe(self, inputStream: java.io.InputStream) -> bool: ...
    def engineSetCertificateEntry(
        self, string: str, certificate: java.security.cert.Certificate
    ) -> None: ...
    def engineSetEntry(
        self,
        string: str,
...
class PEMDecoder:
    ...
    @typing.overload
    def decode(
        self, inputStream: java.io.InputStream, class_: typing.Type[_decode_1__S]
    ) -> _decode_1__S: ...
    @typing.overload
    def decode(self, string: str) -> DEREncodable: ...
    @typing.overload
    def decode(
        self, string: str, class_: typing.Type[_decode_3__S]
    ) -> _decode_3__S: ...
    @staticmethod
    def of() -> "PEMDecoder": ...
    def withDecryption(
...
class Policy:
    ...
    @staticmethod
    def getInstance(
        string: str, parameters: "Policy.Parameters", string2: str
    ) -> "Policy": ...
    @typing.overload
    @staticmethod
    def getInstance(
        string: str, parameters: "Policy.Parameters", provider: "Provider"
    ) -> "Policy": ...
...
class ProtectionDomain:
    ...
    def __init__(
        ...
        principalArray: typing.Union[typing.List[Principal], jpype.JArray],
    ): ...
...
class Provider(java.util.Properties):
    ...
    class Service:
        def __init__(
            ...
            string2: str,
            string3: str,
            list: java.util.List[str],
            map: typing.Union[java.util.Map[str, str], typing.Mapping[str, str]],
        ): ...
        def getAlgorithm(self) -> str: ...
...
class SecureRandom(java.util.Random):
    ...
    @staticmethod
    def getInstance(
        string: str, secureRandomParameters: "SecureRandomParameters"
    ) -> "SecureRandom": ...
    @typing.overload
    @staticmethod
    def getInstance(
        string: str, secureRandomParameters: "SecureRandomParameters", string2: str
    ) -> "SecureRandom": ...
    @typing.overload
    @staticmethod
    def getInstance(
...
class AuthProvider(Provider):
    def login(
        ...
        callbackHandler: typing.Union[
            javax.security.auth.callback.CallbackHandler, typing.Callable
        ],
    ) -> None: ...
...
class DrbgParameters:
    ...
    @staticmethod
    def reseed(
        boolean: bool, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]
...
class PEMRecord(java.lang.Record, DEREncodable):
    ...
    def __init__(
        ...
        type: str,
        content: str,
        leadingData: typing.Union[typing.List[int], jpype.JArray, bytes],
    ): ...
...
class Signature(SignatureSpi):
    ...
    @typing.overload
    def initSign(
        self, privateKey: "PrivateKey", secureRandom: SecureRandom
    ) -> None: ...
    @typing.overload
...
class IdentityScope(Identity):
    ...
    @typing.overload
    def getIdentity(
        self, principal: typing.Union[Principal, typing.Callable]
    ) -> Identity: ...
    @staticmethod
...
class DomainLoadStoreParameter(java.security.KeyStore.LoadStoreParameter):
    def __init__(
        ...
        uRI: java.net.URI,
        map: typing.Union[
            java.util.Map[str, "KeyStore.ProtectionParameter"],
            typing.Mapping[str, "KeyStore.ProtectionParameter"],
        ],
    ): ...
