...
class AWTKeyStroke(java.io.Serializable):
    ...
    @typing.overload
    @staticmethod
    def getAWTKeyStroke(string: typing.Union[java.lang.String, str]) -> 'AWTKeyStroke': ...
    @staticmethod
...
class Cursor(java.io.Serializable):
    ...
    @staticmethod
    def getSystemCustomCursor(string: typing.Union[java.lang.String, str]) -> 'Cursor': ...
...
class Desktop:
    ...
    class Action(java.lang.Enum['Desktop.Action']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'Desktop.Action': ...
        @typing.overload
        @staticmethod
...
class Font(java.io.Serializable):
    ...
    @typing.overload
    def canDisplayUpTo(self, string: typing.Union[java.lang.String, str]) -> int: ...
    @typing.overload
    ...
    @typing.overload
    def createGlyphVector(self, fontRenderContext: java.awt.font.FontRenderContext, string: typing.Union[java.lang.String, str]) -> java.awt.font.GlyphVector: ...
    @typing.overload
    ...
    @staticmethod
    def decode(string: typing.Union[java.lang.String, str]) -> 'Font': ...
    @typing.overload
    ...
    @typing.overload
    @staticmethod
    def getFont(string: typing.Union[java.lang.String, str]) -> 'Font': ...
    @typing.overload
    @staticmethod
    def getFont(string: typing.Union[java.lang.String, str], font: 'Font') -> 'Font': ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    def getLineMetrics(self, string: typing.Union[java.lang.String, str], int: int, int2: int, fontRenderContext: java.awt.font.FontRenderContext) -> java.awt.font.LineMetrics: ...
    @typing.overload
    def getLineMetrics(self, string: typing.Union[java.lang.String, str], fontRenderContext: java.awt.font.FontRenderContext) -> java.awt.font.LineMetrics: ...
    @typing.overload
    ...
    @typing.overload
    def getStringBounds(self, string: typing.Union[java.lang.String, str], int: int, int2: int, fontRenderContext: java.awt.font.FontRenderContext) -> java.awt.geom.Rectangle2D: ...
    @typing.overload
    def getStringBounds(self, string: typing.Union[java.lang.String, str], fontRenderContext: java.awt.font.FontRenderContext) -> java.awt.geom.Rectangle2D: ...
    @typing.overload
...
class FontMetrics(java.io.Serializable):
    ...
    @typing.overload
    def getLineMetrics(self, string: typing.Union[java.lang.String, str], int: int, int2: int, graphics: 'Graphics') -> java.awt.font.LineMetrics: ...
    @typing.overload
    def getLineMetrics(self, string: typing.Union[java.lang.String, str], graphics: 'Graphics') -> java.awt.font.LineMetrics: ...
    @typing.overload
    ...
    @typing.overload
    def getStringBounds(self, string: typing.Union[java.lang.String, str], int: int, int2: int, graphics: 'Graphics') -> java.awt.geom.Rectangle2D: ...
    @typing.overload
    def getStringBounds(self, string: typing.Union[java.lang.String, str], graphics: 'Graphics') -> java.awt.geom.Rectangle2D: ...
    @typing.overload
    ...
    def hasUniformLineMetrics(self) -> bool: ...
    def stringWidth(self, string: typing.Union[java.lang.String, str]) -> int: ...
    def toString(self) -> java.lang.String: ...
...
class GraphicsDevice:
    ...
    class WindowTranslucency(java.lang.Enum['GraphicsDevice.WindowTranslucency']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'GraphicsDevice.WindowTranslucency': ...
        @typing.overload
        @staticmethod
        def valueOf(class_: typing.Type[_valueOf_1__T], string: typing.Union[java.lang.String, str]) -> _valueOf_1__T: ...
        @staticmethod
...
class GraphicsEnvironment:
    ...
    @typing.overload
    def getAvailableFontFamilyNames(self) -> typing.MutableSequence[java.lang.String]: ...
    @typing.overload
    def getAvailableFontFamilyNames(self, locale: java.util.Locale) -> typing.MutableSequence[java.lang.String]: ...
...
class Image:
    ...
    def getProperty(self, string: typing.Union[java.lang.String, str], imageObserver: typing.Union[java.awt.image.ImageObserver, typing.Callable]) -> typing.Any: ...
...
class LayoutManager:
    def addLayoutComponent(self, string: typing.Union[java.lang.String, str], component: 'Component') -> None: ...
...
class SystemTray:
    ...
    def getPropertyChangeListeners(self, string: typing.Union[java.lang.String, str]) -> typing.MutableSequence[java.beans.PropertyChangeListener]: ...
    @staticmethod
...
class Taskbar:
    ...
    class Feature(java.lang.Enum['Taskbar.Feature']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'Taskbar.Feature': ...
        @typing.overload
        @staticmethod
        def valueOf(class_: typing.Type[_valueOf_1__T], string: typing.Union[java.lang.String, str]) -> _valueOf_1__T: ...
        @staticmethod
    ...
    class State(java.lang.Enum['Taskbar.State']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'Taskbar.State': ...
        @typing.overload
        @staticmethod
        def valueOf(class_: typing.Type[_valueOf_1__T], string: typing.Union[java.lang.String, str]) -> _valueOf_1__T: ...
        @staticmethod
...
class Toolkit:
    ...
    def createCustomCursor(self, image: Image, point: Point, string: typing.Union[java.lang.String, str]) -> Cursor: ...
    ...
    @typing.overload
    def createImage(self, string: typing.Union[java.lang.String, str]) -> Image: ...
    @typing.overload
    ...
    def getDesktopProperty(self, string: typing.Union[java.lang.String, str]) -> typing.Any: ...
    def getFontList(self) -> typing.MutableSequence[java.lang.String]: ...
    def getFontMetrics(self, font: Font) -> FontMetrics: ...
    @typing.overload
    def getImage(self, string: typing.Union[java.lang.String, str]) -> Image: ...
    @typing.overload
    ...
    @typing.overload
    def getPrintJob(self, frame: 'Frame', string: typing.Union[java.lang.String, str], properties: java.util.Properties) -> PrintJob: ...
    @typing.overload
    def getPrintJob(self, frame: 'Frame', string: typing.Union[java.lang.String, str], jobAttributes: 'JobAttributes', pageAttributes: 'PageAttributes') -> PrintJob: ...
    @staticmethod
    def getProperty(string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> java.lang.String: ...
    @typing.overload
...
class TrayIcon:
    ...
    @typing.overload
    def __init__(self, image: Image, string: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, image: Image, string: typing.Union[java.lang.String, str], popupMenu: 'PopupMenu'): ...
    ...
    def displayMessage(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], messageType: 'TrayIcon.MessageType') -> None: ...
    ...
    def setActionCommand(self, string: typing.Union[java.lang.String, str]) -> None: ...
    ...
    class MessageType(java.lang.Enum['TrayIcon.MessageType']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'TrayIcon.MessageType': ...
        @typing.overload
        @staticmethod
        def valueOf(class_: typing.Type[_valueOf_1__T], string: typing.Union[java.lang.String, str]) -> _valueOf_1__T: ...
        @staticmethod
...
class Component(java.awt.image.ImageObserver, MenuContainer, java.io.Serializable):
    ...
    @typing.overload
    def firePropertyChange(self, string: typing.Union[java.lang.String, str], byte: int, byte2: int) -> None: ...
    @typing.overload
    def firePropertyChange(self, string: typing.Union[java.lang.String, str], char: str, char2: str) -> None: ...
    @typing.overload
    def firePropertyChange(self, string: typing.Union[java.lang.String, str], double: float, double2: float) -> None: ...
    @typing.overload
    def firePropertyChange(self, string: typing.Union[java.lang.String, str], float: float, float2: float) -> None: ...
    @typing.overload
    def firePropertyChange(self, string: typing.Union[java.lang.String, str], long: int, long2: int) -> None: ...
    @typing.overload
    def firePropertyChange(self, string: typing.Union[java.lang.String, str], short: int, short2: int) -> None: ...
    def getAccessibleContext(self) -> javax.accessibility.AccessibleContext: ...
    ...
    class BaselineResizeBehavior(java.lang.Enum['Component.BaselineResizeBehavior']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'Component.BaselineResizeBehavior': ...
        @typing.overload
        @staticmethod
        def valueOf(class_: typing.Type[_valueOf_1__T], string: typing.Union[java.lang.String, str]) -> _valueOf_1__T: ...
        @staticmethod
...
class KeyboardFocusManager(KeyEventDispatcher, KeyEventPostProcessor):
    ...
    @typing.overload
    def getVetoableChangeListeners(self, string: typing.Union[java.lang.String, str]) -> typing.MutableSequence[java.beans.VetoableChangeListener]: ...
    def postProcessKeyEvent(self, keyEvent: java.awt.event.KeyEvent) -> bool: ...
...
class MenuItem(MenuComponent, javax.accessibility.Accessible):
    ...
    def __init__(self, string: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], menuShortcut: MenuShortcut): ...
    def addActionListener(self, actionListener: typing.Union[java.awt.event.ActionListener, typing.Callable]) -> None: ...
    def addNotify(self) -> None: ...
...
class CardLayout(LayoutManager2, java.io.Serializable):
    ...
    def setHgap(self, int: int) -> None: ...
    def setVgap(self, int: int) -> None: ...
    def show(self, container: 'Container', string: typing.Union[java.lang.String, str]) -> None: ...
    def toString(self) -> java.lang.String: ...
...
class Checkbox(Component, ItemSelectable, javax.accessibility.Accessible):
    ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], boolean: bool, checkboxGroup: CheckboxGroup): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], checkboxGroup: CheckboxGroup, boolean: bool): ...
    def addItemListener(self, itemListener: typing.Union[java.awt.event.ItemListener, typing.Callable]) -> None: ...
    def addNotify(self) -> None: ...
    def getAccessibleContext(self) -> javax.accessibility.AccessibleContext: ...
...
class Choice(Component, ItemSelectable, javax.accessibility.Accessible):
    ...
    @typing.overload
    def add(self, popupMenu: 'PopupMenu') -> None: ...
    def addItem(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def addItemListener(self, itemListener: typing.Union[java.awt.event.ItemListener, typing.Callable]) -> None: ...
    def addNotify(self) -> None: ...
    ...
    @typing.overload
    def select(self, string: typing.Union[java.lang.String, str]) -> None: ...
...
class Color(Paint, java.io.Serializable):
    ...
    @staticmethod
    def decode(string: typing.Union[java.lang.String, str]) -> 'Color': ...
    def equals(self, object: typing.Any) -> bool: ...
    def getAlpha(self) -> int: ...
    def getBlue(self) -> int: ...
    @typing.overload
    @staticmethod
    def getColor(string: typing.Union[java.lang.String, str]) -> 'Color': ...
    @typing.overload
    @staticmethod
    def getColor(string: typing.Union[java.lang.String, str], int: int) -> 'Color': ...
    @typing.overload
    @staticmethod
    def getColor(string: typing.Union[java.lang.String, str], color: 'Color') -> 'Color': ...
    @typing.overload
...
class Container(Component):
    ...
    @typing.overload
    def add(self, string: typing.Union[java.lang.String, str], component: Component) -> Component: ...
    @typing.overload
    def add(self, popupMenu: 'PopupMenu') -> None: ...
    @typing.overload
...
class List(Component, ItemSelectable, javax.accessibility.Accessible):
    ...
    def addActionListener(self, actionListener: typing.Union[java.awt.event.ActionListener, typing.Callable]) -> None: ...
    @typing.overload
    def addItem(self, string: typing.Union[java.lang.String, str], int: int) -> None: ...
    @typing.overload
    def addItem(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def addItemListener(self, itemListener: typing.Union[java.awt.event.ItemListener, typing.Callable]) -> None: ...
    def addNotify(self) -> None: ...
    ...
    def removeItemListener(self, itemListener: typing.Union[java.awt.event.ItemListener, typing.Callable]) -> None: ...
    def removeNotify(self) -> None: ...
    def replaceItem(self, string: typing.Union[java.lang.String, str], int: int) -> None: ...
    def select(self, int: int) -> None: ...
...
class MultipleGradientPaint(Paint):
    ...
    class ColorSpaceType(java.lang.Enum['MultipleGradientPaint.ColorSpaceType']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'MultipleGradientPaint.ColorSpaceType': ...
        @typing.overload
        @staticmethod
        def valueOf(class_: typing.Type[_valueOf_1__T], string: typing.Union[java.lang.String, str]) -> _valueOf_1__T: ...
        @staticmethod
    ...
    class CycleMethod(java.lang.Enum['MultipleGradientPaint.CycleMethod']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'MultipleGradientPaint.CycleMethod': ...
        @typing.overload
        @staticmethod
        def valueOf(class_: typing.Type[_valueOf_1__T], string: typing.Union[java.lang.String, str]) -> _valueOf_1__T: ...
        @staticmethod
...
class TextArea(TextComponent):
    ...
    def addNotify(self) -> None: ...
    def append(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def appendText(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def getAccessibleContext(self) -> javax.accessibility.AccessibleContext: ...
    def getColumns(self) -> int: ...
    @typing.overload
    def getMinimumSize(self) -> Dimension: ...
    ...
    def insert(self, string: typing.Union[java.lang.String, str], int: int) -> None: ...
    def insertText(self, string: typing.Union[java.lang.String, str], int: int) -> None: ...
    @typing.overload
    def minimumSize(self) -> Dimension: ...
    @typing.overload
    ...
    def replaceText(self, string: typing.Union[java.lang.String, str], int: int, int2: int) -> None: ...
    def setColumns(self, int: int) -> None: ...
    def setRows(self, int: int) -> None: ...
...
class Window(Container, javax.accessibility.Accessible):
    ...
    @typing.overload
    def applyResourceBundle(self, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    ...
    class Type(java.lang.Enum['Window.Type']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'Window.Type': ...
        @typing.overload
        @staticmethod
        def valueOf(class_: typing.Type[_valueOf_1__T], string: typing.Union[java.lang.String, str]) -> _valueOf_1__T: ...
        @staticmethod
...
class Dialog(Window):
    ...
    @typing.overload
    def __init__(self, dialog: 'Dialog', string: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, dialog: 'Dialog', string: typing.Union[java.lang.String, str], boolean: bool): ...
    @typing.overload
    def __init__(self, dialog: 'Dialog', string: typing.Union[java.lang.String, str], boolean: bool, graphicsConfiguration: GraphicsConfiguration): ...
    @typing.overload
    def __init__(self, frame: 'Frame'): ...
    @typing.overload
    def __init__(self, frame: 'Frame', boolean: bool): ...
    @typing.overload
    def __init__(self, frame: 'Frame', string: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, frame: 'Frame', string: typing.Union[java.lang.String, str], boolean: bool): ...
    @typing.overload
    def __init__(self, frame: 'Frame', string: typing.Union[java.lang.String, str], boolean: bool, graphicsConfiguration: GraphicsConfiguration): ...
    @typing.overload
    def __init__(self, window: Window): ...
    @typing.overload
    def __init__(self, window: Window, modalityType: 'Dialog.ModalityType'): ...
    @typing.overload
    def __init__(self, window: Window, string: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, window: Window, string: typing.Union[java.lang.String, str], modalityType: 'Dialog.ModalityType'): ...
    @typing.overload
    def __init__(self, window: Window, string: typing.Union[java.lang.String, str], modalityType: 'Dialog.ModalityType', graphicsConfiguration: GraphicsConfiguration): ...
    def addNotify(self) -> None: ...
    def getAccessibleContext(self) -> javax.accessibility.AccessibleContext: ...
    ...
    class ModalExclusionType(java.lang.Enum['Dialog.ModalExclusionType']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'Dialog.ModalExclusionType': ...
        @typing.overload
        @staticmethod
        def valueOf(class_: typing.Type[_valueOf_1__T], string: typing.Union[java.lang.String, str]) -> _valueOf_1__T: ...
        @staticmethod
    ...
    class ModalityType(java.lang.Enum['Dialog.ModalityType']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'Dialog.ModalityType': ...
        @typing.overload
        @staticmethod
        def valueOf(class_: typing.Type[_valueOf_1__T], string: typing.Union[java.lang.String, str]) -> _valueOf_1__T: ...
        @staticmethod
...
class Frame(Window, MenuContainer):
    ...
    def __init__(self, string: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], graphicsConfiguration: GraphicsConfiguration): ...
    def addNotify(self) -> None: ...
    def getAccessibleContext(self) -> javax.accessibility.AccessibleContext: ...
...
class FileDialog(Dialog):
    ...
    def __init__(self, dialog: Dialog, string: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, dialog: Dialog, string: typing.Union[java.lang.String, str], int: int): ...
    @typing.overload
    def __init__(self, frame: Frame): ...
    @typing.overload
    def __init__(self, frame: Frame, string: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, frame: Frame, string: typing.Union[java.lang.String, str], int: int): ...
    def addNotify(self) -> None: ...
...
class JobAttributes(java.lang.Cloneable):
    ...
    def __init__(self): ...
    @typing.overload
    def __init__(self, int: int, defaultSelectionType: 'JobAttributes.DefaultSelectionType', destinationType: 'JobAttributes.DestinationType', dialogType: 'JobAttributes.DialogType', string: typing.Union[java.lang.String, str], int2: int, int3: int, multipleDocumentHandlingType: 'JobAttributes.MultipleDocumentHandlingType', intArray: typing.Union[typing.List[typing.MutableSequence[int]], jpype.JArray], string2: typing.Union[java.lang.String, str], sidesType: 'JobAttributes.SidesType'): ...
    @typing.overload
    ...
    def setPrinter(self, string: typing.Union[java.lang.String, str]) -> None: ...
