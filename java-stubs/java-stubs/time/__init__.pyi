...
class DayOfWeek(
    ...
    def query(
        self,
        temporalQuery: typing.Union[
            java.time.temporal.TemporalQuery[_query__R],
...
class Instant(
    ...
    @typing.overload
    def until(
        self, instant: typing.Union["Instant", datetime.datetime]
    ) -> Duration: ...
    @typing.overload
    def until(
        self,
    ...
    def with_(
        self,
        temporalAdjuster: typing.Union[
            java.time.temporal.TemporalAdjuster, typing.Callable
        ],
    ) -> "Instant": ...
    @typing.overload
    def with_(
...
class InstantSource:
    ...
    @staticmethod
    def offset(
        instantSource: typing.Union["InstantSource", typing.Callable],
        duration: Duration,
    ) -> "InstantSource": ...
    @staticmethod
...
class LocalDate(
    ...
    @staticmethod
    def ofInstant(
        instant: typing.Union[Instant, datetime.datetime], zoneId: "ZoneId"
    ) -> "LocalDate": ...
    @staticmethod
    ...
    def toEpochSecond(
        self, localTime: "LocalTime", zoneOffset: "ZoneOffset"
    ) -> int: ...
    def toString(self) -> java.lang.String: ...
    @typing.overload
...
class LocalDateTime(
    ...
    @staticmethod
    def ofEpochSecond(
        long: int, int: int, zoneOffset: "ZoneOffset"
    ) -> "LocalDateTime": ...
    @staticmethod
    def ofInstant(
        instant: typing.Union[Instant, datetime.datetime], zoneId: "ZoneId"
...
class ZoneId(java.io.Serializable):
    ...
    @staticmethod
    def ofOffset(
        string: typing.Union[java.lang.String, str], zoneOffset: "ZoneOffset"
    ) -> "ZoneId": ...
    @staticmethod
