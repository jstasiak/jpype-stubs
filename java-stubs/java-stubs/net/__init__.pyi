...
class Socket(java.io.Closeable):
    ...
    @typing.overload
    def __init__(
        self, string: typing.Union[java.lang.String, str], int: int, boolean: bool
    ): ...
    @typing.overload
    def __init__(
        self,
...
class URLDecoder:
    ...
    @staticmethod
    def decode(
        string: typing.Union[java.lang.String, str], charset: java.nio.charset.Charset
    ) -> java.lang.String: ...
