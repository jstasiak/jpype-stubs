...
class AccessControlException(java.lang.SecurityException):
    ...
    @typing.overload
    def __init__(
        self, string: typing.Union[java.lang.String, str], permission: "Permission"
    ): ...
...
class AlgorithmParameterGenerator:
    ...
    @staticmethod
    def getInstance(
        string: typing.Union[java.lang.String, str], provider: "Provider"
    ) -> "AlgorithmParameterGenerator": ...
...
class KeyStoreSpi:
    ...
    def engineContainsAlias(
        self, string: typing.Union[java.lang.String, str]
    ) -> bool: ...
    def engineDeleteEntry(
        self, string: typing.Union[java.lang.String, str]
    ) -> None: ...
    def engineEntryInstanceOf(
        self,
        string: typing.Union[java.lang.String, str],
        class_: typing.Type["KeyStore.Entry"],
    ) -> bool: ...
...
class PEMDecoder:
    ...
    def decode(
        self,
        string: typing.Union[java.lang.String, str],
        class_: typing.Type[_decode_3__S],
    ) -> _decode_3__S: ...
    @staticmethod
    def of() -> "PEMDecoder": ...
    def withDecryption(
...
class Policy:
    ...
    @staticmethod
    def getInstance(
        string: typing.Union[java.lang.String, str], parameters: "Policy.Parameters"
    ) -> "Policy": ...
    @typing.overload
    @staticmethod
    def getInstance(
...
class PEMRecord(java.lang.Record, DEREncodable):
    ...
    def __init__(
        self,
        type: typing.Union[java.lang.String, str],
        content: typing.Union[java.lang.String, str],
...
class Signer(Identity):
    ...
    @typing.overload
    def __init__(
        self, string: typing.Union[java.lang.String, str], identityScope: IdentityScope
    ): ...
...
class DomainLoadStoreParameter(java.security.KeyStore.LoadStoreParameter):
    def __init__(
        ...
        map: typing.Union[
            java.util.Map[
                typing.Union[java.lang.String, str], "KeyStore.ProtectionParameter"
            ],
            typing.Mapping[
                typing.Union[java.lang.String, str], "KeyStore.ProtectionParameter"
            ],
