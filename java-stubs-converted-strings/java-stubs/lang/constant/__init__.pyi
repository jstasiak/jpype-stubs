...
class DynamicCallSiteDesc:
    ...
    def withNameAndType(
        self, string: str, methodTypeDesc: "MethodTypeDesc"
    ) -> "DynamicCallSiteDesc": ...
...
class DynamicConstantDesc(ConstantDesc, typing.Generic[_DynamicConstantDesc__T]):
    ...
    def ofCanonical(
        ...
        string: str,
        classDesc: ClassDesc,
        constantDescArray: typing.Union[typing.List[ConstantDesc], jpype.JArray],
    ) -> ConstantDesc: ...
...
class MethodTypeDesc(
    ...
    @staticmethod
    def of(
        classDesc: ClassDesc, list: java.util.List[ClassDesc]
    ) -> "MethodTypeDesc": ...
    @staticmethod
