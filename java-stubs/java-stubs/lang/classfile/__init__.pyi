...
class AnnotationElement:
    ...
    @staticmethod
    def of(
        string: typing.Union[java.lang.String, str], annotationValue: "AnnotationValue"
    ) -> "AnnotationElement": ...
    @typing.overload
    @staticmethod
    def of(
    ...
    @staticmethod
    def ofAnnotation(
        string: typing.Union[java.lang.String, str], annotation: Annotation
    ) -> "AnnotationElement": ...
    @staticmethod
    def ofArray(
        string: typing.Union[java.lang.String, str], *annotationValue: "AnnotationValue"
    ...
    @staticmethod
    def ofByte(
        string: typing.Union[java.lang.String, str], byte: int
    ) -> "AnnotationElement": ...
    @staticmethod
    def ofChar(
        string: typing.Union[java.lang.String, str], char: str
    ) -> "AnnotationElement": ...
    @staticmethod
    def ofClass(
    ...
    @staticmethod
    def ofFloat(
        string: typing.Union[java.lang.String, str], float: float
    ) -> "AnnotationElement": ...
    @staticmethod
    def ofInt(
    ...
    @staticmethod
    def ofLong(
        string: typing.Union[java.lang.String, str], long: int
    ) -> "AnnotationElement": ...
    @staticmethod
    def ofShort(
        string: typing.Union[java.lang.String, str], short: int
    ) -> "AnnotationElement": ...
    @staticmethod
    def ofString(
        string: typing.Union[java.lang.String, str],
...
class AttributeMapper(typing.Generic[_AttributeMapper__A]):
    ...
    def writeAttribute(
        self, bufWriter: "BufWriter", a: _AttributeMapper__A
    ) -> None: ...
...
class ClassHierarchyResolver:
    ...
    def of(
        collection: typing.Union[
            java.util.Collection[java.lang.constant.ClassDesc],
            typing.Sequence[java.lang.constant.ClassDesc],
            typing.Set[java.lang.constant.ClassDesc],
        ],
        map: typing.Union[
            java.util.Map[java.lang.constant.ClassDesc, java.lang.constant.ClassDesc],
    ...
    def orElse(
        self,
        classHierarchyResolver: typing.Union["ClassHierarchyResolver", typing.Callable],
    ) -> "ClassHierarchyResolver": ...
...
class ClassReader(java.lang.classfile.constantpool.ConstantPool):
    ...
    @typing.overload
    def readEntry(
        self, int: int, class_: typing.Type[_readEntry_1__T]
    ) -> _readEntry_1__T: ...
    ...
    @typing.overload
    def readEntryOrNull(
        self, int: int, class_: typing.Type[_readEntryOrNull_1__T]
...
class ClassBuilder(ClassFileBuilder["ClassElement", "ClassBuilder"]):
    def transformField(
        ...
        fieldTransform: typing.Union["FieldTransform", typing.Callable],
    ) -> "ClassBuilder": ...
    def transformMethod(
        self,
        methodModel: "MethodModel",
        methodTransform: typing.Union["MethodTransform", typing.Callable],
    ) -> "ClassBuilder": ...
    @typing.overload
    def withField(
        self,
        ...
        consumer: typing.Union[
            java.util.function.Consumer["FieldBuilder"],
    ...
    def withMethod(
        ...
        int: int,
        consumer: typing.Union[
            java.util.function.Consumer["MethodBuilder"],
...
class ClassTransform(ClassFileTransform["ClassTransform", ClassElement, ClassBuilder]):
    ...
    def andThen(
        self, classTransform: typing.Union["ClassTransform", typing.Callable]
    ) -> "ClassTransform": ...
    @staticmethod
    def dropping(
        predicate: typing.Union[
            java.util.function.Predicate[ClassElement],
    ...
    def endHandler(
        consumer: typing.Union[
            java.util.function.Consumer[ClassBuilder],
    ...
    def ofStateful(
        supplier: typing.Union[
            java.util.function.Supplier[
                typing.Union["ClassTransform", typing.Callable]
            ],
            typing.Callable[[], typing.Union["ClassTransform", typing.Callable]],
        ],
    ) -> "ClassTransform": ...
    @staticmethod
    ...
    def transformingMethodBodies(
        codeTransform: typing.Union["CodeTransform", typing.Callable],
    ) -> "ClassTransform": ...
    @typing.overload
    @staticmethod
    def transformingMethodBodies(
        predicate: typing.Union[
            java.util.function.Predicate["MethodModel"],
...
class CodeTransform(ClassFileTransform["CodeTransform", CodeElement, "CodeBuilder"]):
    ...
    def andThen(
        self, codeTransform: typing.Union["CodeTransform", typing.Callable]
    ) -> "CodeTransform": ...
    @staticmethod
    def endHandler(
        consumer: typing.Union[
    ...
    def ofStateful(
        supplier: typing.Union[
            java.util.function.Supplier[typing.Union["CodeTransform", typing.Callable]],
            typing.Callable[[], typing.Union["CodeTransform", typing.Callable]],
        ],
    ) -> "CodeTransform": ...
...
class CompoundElement(
    ...
    def forEach(
        self,
        consumer: typing.Union[
            java.util.function.Consumer[_CompoundElement__E],
...
class FieldTransform(ClassFileTransform["FieldTransform", FieldElement, FieldBuilder]):
    ...
    def andThen(
        self, fieldTransform: typing.Union["FieldTransform", typing.Callable]
    ) -> "FieldTransform": ...
    @staticmethod
    def dropping(
        predicate: typing.Union[
            java.util.function.Predicate[FieldElement],
    ...
    def ofStateful(
        supplier: typing.Union[
            java.util.function.Supplier[
                typing.Union["FieldTransform", typing.Callable]
            ],
            typing.Callable[[], typing.Union["FieldTransform", typing.Callable]],
        ],
    ) -> "FieldTransform": ...
...
class MethodTransform(
    ...
    def andThen(
        self, methodTransform: typing.Union["MethodTransform", typing.Callable]
    ) -> "MethodTransform": ...
    @staticmethod
    def dropping(
        predicate: typing.Union[
            java.util.function.Predicate[MethodElement],
    ...
    def ofStateful(
        supplier: typing.Union[
            java.util.function.Supplier[
                typing.Union["MethodTransform", typing.Callable]
            ],
            typing.Callable[[], typing.Union["MethodTransform", typing.Callable]],
        ],
    ) -> "MethodTransform": ...
    @staticmethod
...
class AnnotationValue:
    ...
    @staticmethod
    def ofArray(
        list: java.util.List["AnnotationValue"],
...
class ClassFile:
    ...
    def transformClass(
        ...
        classEntry: java.lang.classfile.constantpool.ClassEntry,
        classTransform: typing.Union[ClassTransform, typing.Callable],
    ) -> typing.MutableSequence[int]: ...
    @typing.overload
    def transformClass(
        self,
    ...
    class AttributesProcessingOption(
        ...
        PASS_ALL_ATTRIBUTES: typing.ClassVar[
    ...
    class ClassHierarchyResolverOption(java.lang.classfile.ClassFile.Option):
        ...
        @staticmethod
        def of(
            classHierarchyResolver: typing.Union[
                ClassHierarchyResolver, typing.Callable
            ],
...
class CodeBuilder(ClassFileBuilder[CodeElement, "CodeBuilder"]):
    ...
    def block(
        self,
        consumer: typing.Union[
            java.util.function.Consumer["CodeBuilder.BlockCodeBuilder"],
    ...
    def trying(
        ...
        consumer2: typing.Union[
            java.util.function.Consumer["CodeBuilder.CatchBuilder"],
...
class Signature:
    ...
    class ClassTypeSig(
        ...
        @staticmethod
        def of(
            string: typing.Union[java.lang.String, str], *typeArg: "Signature.TypeArg"
...
class TypeAnnotation:
    ...
    class TargetType(java.lang.Enum["TypeAnnotation.TargetType"]):
        ...
        METHOD_REFERENCE_TYPE_ARGUMENT: typing.ClassVar[
            "TypeAnnotation.TargetType"
        ] = ...
        def sizeIfFixed(self) -> int: ...
