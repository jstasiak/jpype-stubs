...
class HttpClient(java.lang.AutoCloseable):
    ...
    def send(
        ...
        bodyHandler: typing.Union[
            "HttpResponse.BodyHandler"[_send__T],
            typing.Callable[
    ...
    def sendAsync(
        ...
        httpRequest: "HttpRequest",
        bodyHandler: typing.Union[
            "HttpResponse.BodyHandler"[_sendAsync_0__T],
            typing.Callable[
                ["HttpResponse.ResponseInfo"], "HttpResponse.BodySubscriber"[typing.Any]
            ],
        ],
    ...
    def sendAsync(
        ...
        httpRequest: "HttpRequest",
        bodyHandler: typing.Union[
            "HttpResponse.BodyHandler"[_sendAsync_1__T],
            typing.Callable[
                ["HttpResponse.ResponseInfo"], "HttpResponse.BodySubscriber"[typing.Any]
            ],
        ],
        pushPromiseHandler: typing.Union[
            "HttpResponse.PushPromiseHandler"[_sendAsync_1__T],
            typing.Callable[
                [
                    "HttpRequest",
                    "HttpRequest",
    ...
    class Builder:
        ...
        def executor(
            self, executor: typing.Union[java.util.concurrent.Executor, typing.Callable]
        ) -> "HttpClient.Builder": ...
        def followRedirects(
...
class HttpHeaders:
    ...
    def of(
        map: typing.Union[
            java.util.Map[str, java.util.List[str]],
            typing.Mapping[str, java.util.List[str]],
        ],
        biPredicate: typing.Union[
            java.util.function.BiPredicate[str, str], typing.Callable[[str, str], bool]
        ],
    ) -> "HttpHeaders": ...
...
class HttpRequest:
    ...
    class BodyPublishers:
        ...
        @staticmethod
        def fromPublisher(
            publisher: typing.Union[
                java.util.concurrent.Flow.Publisher[java.nio.ByteBuffer],
                typing.Callable[
                    [java.util.concurrent.Flow.Subscriber[typing.Any]], None
                ],
            ],
        ) -> "HttpRequest.BodyPublisher": ...
        @typing.overload
        ...
        def ofByteArrays(
            iterable: typing.Union[
                java.lang.Iterable[typing.Union[typing.List[int], jpype.JArray, bytes]],
                typing.Sequence[typing.Union[typing.List[int], jpype.JArray, bytes]],
                typing.Set[typing.Union[typing.List[int], jpype.JArray, bytes]],
        ...
        @staticmethod
        def ofString(
            string: str, charset: java.nio.charset.Charset
        ) -> "HttpRequest.BodyPublisher": ...
    ...
    class Builder:
        ...
        def method(
            self, string: str, bodyPublisher: "HttpRequest.BodyPublisher"
        ) -> "HttpRequest.Builder": ...
...
class HttpResponse(typing.Generic[_HttpResponse__T]):
    ...
    class BodyHandlers:
        ...
        def fromLineSubscriber(
            subscriber: java.util.concurrent.Flow.Subscriber[str],
        ...
        def fromSubscriber(
            ...
            function: typing.Union[
                java.util.function.Function[_fromSubscriber_1__S, _fromSubscriber_1__T],
        ...
        @staticmethod
        def ofByteArray() -> "HttpResponse.BodyHandler"[
        ...
        def ofByteArrayConsumer(
            consumer: typing.Union[
                java.util.function.Consumer[
                    java.util.Optional[
                        typing.Union[typing.List[int], jpype.JArray, bytes]
                    ]
                ],
                typing.Callable[
                    [
        ...
        ) -> "HttpResponse.BodyHandler"[str]: ...
        _replacing__U = typing.TypeVar("_replacing__U")  # <U>
        @staticmethod
        def replacing(
            u: _replacing__U,
        ) -> "HttpResponse.BodyHandler"[_replacing__U]: ...
    ...
    class BodySubscribers:
        ...
        def ofLines(
            charset: java.nio.charset.Charset,
        ) -> "HttpResponse.BodySubscriber"[java.util.stream.Stream[str]]: ...
        @staticmethod
        ...
        def ofString(
            charset: java.nio.charset.Charset,
        ) -> "HttpResponse.BodySubscriber"[str]: ...
        _replacing__U = typing.TypeVar("_replacing__U")  # <U>
        @staticmethod
        def replacing(
            u: _replacing__U,
...
class WebSocket:
    ...
    def sendText(
        self, charSequence: typing.Union[java.lang.CharSequence, str], boolean: bool
    ) -> java.util.concurrent.CompletableFuture["WebSocket"]: ...
    class Builder:
        def buildAsync(
    ...
    class Listener:
        ...
        def onClose(
            self, webSocket: "WebSocket", int: int, string: str
        ) -> java.util.concurrent.CompletionStage[typing.Any]: ...
        def onError(
