...
class Pattern(java.io.Serializable):
    ...
    @staticmethod
    def matches(
        string: str, charSequence: typing.Union[java.lang.CharSequence, str]
    ) -> bool: ...
    def namedGroups(self) -> java.util.Map[str, int]: ...
    ...
    @typing.overload
    def split(
        self, charSequence: typing.Union[java.lang.CharSequence, str], int: int
    ) -> typing.MutableSequence[str]: ...
    def splitAsStream(
        self, charSequence: typing.Union[java.lang.CharSequence, str]
...
class Matcher(MatchResult):
    ...
    def appendReplacement(
        self, stringBuffer: java.lang.StringBuffer, string2: str
    ) -> "Matcher": ...
    @typing.overload
    def appendReplacement(
        self, stringBuilder: java.lang.StringBuilder, string2: str
    ) -> "Matcher": ...
    @typing.overload
    def appendTail(
    ...
    def replaceAll(
        ...
        function: typing.Union[
            java.util.function.Function[MatchResult, str],
            typing.Callable[[MatchResult], str],
        ],
    ) -> str: ...
    @typing.overload
