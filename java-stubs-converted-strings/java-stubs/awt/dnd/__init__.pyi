...
class DragGestureRecognizer(java.io.Serializable):
    def addDragGestureListener(
        self, dragGestureListener: typing.Union[DragGestureListener, typing.Callable]
    ) -> None: ...
    def getComponent(self) -> java.awt.Component: ...
    def getDragSource(self) -> "DragSource": ...
...
class DragSource(java.io.Serializable):
    ...
    def __init__(self): ...
    def addDragSourceListener(
        self, dragSourceListener: "DragSourceListener"
    ) -> None: ...
    def addDragSourceMotionListener(
        self,
        dragSourceMotionListener: typing.Union[
            "DragSourceMotionListener", typing.Callable
        ],
    ) -> None: ...
    def createDefaultDragGestureRecognizer(
        ...
        int: int,
        dragGestureListener: typing.Union[DragGestureListener, typing.Callable],
    ...
    def getDragSourceListeners(
        self,
    ) -> typing.MutableSequence["DragSourceListener"]: ...
