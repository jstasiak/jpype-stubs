...
class AffineTransform(java.lang.Cloneable, java.io.Serializable):
    ...
    def inverseTransform(
        self, point2D: "Point2D", point2D2: "Point2D"
    ) -> "Point2D": ...
    @typing.overload
    def inverseTransform(
        self,
    ...
    def transform(
        self,
        point2DArray: typing.Union[typing.List["Point2D"], jpype.JArray],
        int: int,
        point2DArray2: typing.Union[typing.List["Point2D"], jpype.JArray],
        int2: int,
        int3: int,
    ) -> None: ...
...
class CubicCurve2D(java.awt.Shape, java.lang.Cloneable):
    ...
    @typing.overload
    def setCurve(
        self, point2DArray: typing.Union[typing.List["Point2D"], jpype.JArray], int: int
    ) -> None: ...
    @typing.overload
    @staticmethod
    def solveCubic(
...
class QuadCurve2D(java.awt.Shape, java.lang.Cloneable):
    ...
    def subdivide(
        ...
        quadCurve2D2: "QuadCurve2D",
        quadCurve2D3: "QuadCurve2D",
    ) -> None: ...
    @typing.overload
    def subdivide(
