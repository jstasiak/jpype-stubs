...
class AnnotatedElement:
    ...
    def getAnnotationsByType(
        self, class_: typing.Type[_getAnnotationsByType__T]
    ...
    def getDeclaredAnnotation(
        self, class_: typing.Type[_getDeclaredAnnotation__T]
    ...
    def getDeclaredAnnotationsByType(
        self, class_: typing.Type[_getDeclaredAnnotationsByType__T]
...
class Proxy(java.io.Serializable):
    ...
    @staticmethod
    def getProxyClass(
        classLoader: java.lang.ClassLoader, *class2: typing.Type[typing.Any]
    ...
    def newProxyInstance(
        ...
        invocationHandler: typing.Union[InvocationHandler, typing.Callable],
    ) -> typing.Any: ...
...
class AccessibleObject(AnnotatedElement):
    ...
    @staticmethod
    def setAccessible(
        accessibleObjectArray: typing.Union[
            typing.List["AccessibleObject"], jpype.JArray
        ],
        boolean: bool,
    ) -> None: ...
    @typing.overload
...
class GenericDeclaration(AnnotatedElement):
    def getTypeParameters(
        self,
    ) -> typing.MutableSequence["TypeVariable"[typing.Any]]: ...
...
class __module_protocol__(Protocol):
    ...
    MalformedParameterizedTypeException: typing.Type[
