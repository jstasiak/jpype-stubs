...
class Chronology(java.lang.Comparable["Chronology"]):
    ...
    @typing.overload
    def date(
        self, era: typing.Union["Era", typing.Callable], int: int, int2: int, int3: int
    ) -> ChronoLocalDate: ...
    ...
    @typing.overload
    def dateYearDay(
        self, era: typing.Union["Era", typing.Callable], int: int, int2: int
    ) -> ChronoLocalDate: ...
    @typing.overload
    def epochSecond(
        self,
    ...
    def epochSecond(
        self,
        era: typing.Union["Era", typing.Callable],
        int: int,
        int2: int,
        int3: int,
        int4: int,
    ...
    def prolepticYear(
        self, era: typing.Union["Era", typing.Callable], int: int
    ) -> int: ...
    def range(
    ...
    def resolveDate(
        self,
        map: typing.Union[
            java.util.Map[java.time.temporal.TemporalField, int],
