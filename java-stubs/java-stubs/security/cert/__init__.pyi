...
class CertPathBuilder:
    ...
    @staticmethod
    def getInstance(
        string: typing.Union[java.lang.String, str], provider: java.security.Provider
    ) -> "CertPathBuilder": ...
...
class CertificateRevokedException(CertificateException):
    def __init__(
        ...
        x500Principal: javax.security.auth.x500.X500Principal,
        map: typing.Union[
            java.util.Map[typing.Union[java.lang.String, str], Extension],
            typing.Mapping[typing.Union[java.lang.String, str], Extension],
        ],
    ): ...
...
class PKIXParameters(CertPathParameters):
    ...
    def setInitialPolicies(
        self, set: java.util.Set[typing.Union[java.lang.String, str]]
    ) -> None: ...
