...
class ModuleDescriptor(java.lang.Comparable["ModuleDescriptor"]):
    ...
    def newModule(
        string: typing.Union[java.lang.String, str],
        set: java.util.Set["ModuleDescriptor.Modifier"],
    ) -> "ModuleDescriptor.Builder": ...
    @staticmethod
    def newOpenModule(
        string: typing.Union[java.lang.String, str],
    ...
    def read(
        ...
        supplier: typing.Union[
            java.util.function.Supplier[
                java.util.Set[typing.Union[java.lang.String, str]]
            ],
            typing.Callable[[], java.util.Set[typing.Union[java.lang.String, str]]],
        ],
    ) -> "ModuleDescriptor": ...
    @typing.overload
    @staticmethod
    ...
    class Builder:
        ...
        def exports(
            ...
            set: java.util.Set["ModuleDescriptor.Exports.Modifier"],
            string: typing.Union[java.lang.String, str],
            set2: java.util.Set[typing.Union[java.lang.String, str]],
        ) -> "ModuleDescriptor.Builder": ...
        def mainClass(
            self, string: typing.Union[java.lang.String, str]
        ) -> "ModuleDescriptor.Builder": ...
