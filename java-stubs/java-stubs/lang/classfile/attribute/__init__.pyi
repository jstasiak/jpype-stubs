...
class EnclosingMethodAttribute(
    ...
    def of(
        ...
        optional: java.util.Optional[typing.Union[java.lang.String, str]],
...
class InnerClassInfo:
    ...
    def of(
        ...
        optional2: java.util.Optional[typing.Union[java.lang.String, str]],
        int: int,
    ) -> "InnerClassInfo": ...
    @typing.overload
    @staticmethod
...
class MethodParameterInfo:
    ...
    @staticmethod
    def ofParameter(
        optional: java.util.Optional[typing.Union[java.lang.String, str]], int: int
    ) -> "MethodParameterInfo": ...
...
class ModuleHashesAttribute(
    ...
    @staticmethod
    def of(
        string: typing.Union[java.lang.String, str], *moduleHashInfo: ModuleHashInfo
