...
class BeanInfo:
    ...
    def getEventSetDescriptors(
        self,
    ) -> typing.MutableSequence["EventSetDescriptor"]: ...
    ...
    def getPropertyDescriptors(
        self,
    ) -> typing.MutableSequence["PropertyDescriptor"]: ...
...
class Beans:
    ...
    @staticmethod
    def getInstanceOf(
        object: typing.Any, class_: typing.Type[typing.Any]
    ) -> typing.Any: ...
    @typing.overload
    @staticmethod
...
class Customizer:
    def addPropertyChangeListener(
        self,
        propertyChangeListener: typing.Union["PropertyChangeListener", typing.Callable],
    ) -> None: ...
...
class Encoder:
    ...
    def setExceptionListener(
        self, exceptionListener: typing.Union["ExceptionListener", typing.Callable]
    ) -> None: ...
...
class EventHandler(java.lang.reflect.InvocationHandler):
    ...
    @staticmethod
    def create(
        class_: typing.Type[_create_0__T], object: typing.Any, string: str
    ) -> _create_0__T: ...
    @typing.overload
    @staticmethod
    def create(
        class_: typing.Type[_create_1__T], object: typing.Any, string: str, string2: str
    ) -> _create_1__T: ...
    @typing.overload
    @staticmethod
    def create(
        class_: typing.Type[_create_2__T],
        object: typing.Any,
        string: str,
        string2: str,
        string3: str,
...
class Introspector:
    ...
    @staticmethod
    def getBeanInfo(
        class_: typing.Type[typing.Any], class2: typing.Type[typing.Any], int: int
    ) -> BeanInfo: ...
    @staticmethod
...
class PropertyChangeEvent(java.util.EventObject):
    def __init__(
        self, object: typing.Any, string: str, object2: typing.Any, object3: typing.Any
    ): ...
...
class PropertyChangeSupport(java.io.Serializable):
    ...
    def fireIndexedPropertyChange(
        self, string: str, int: int, boolean: bool, boolean2: bool
    ) -> None: ...
    @typing.overload
    def fireIndexedPropertyChange(
    ...
    @typing.overload
    def fireIndexedPropertyChange(
        self, string: str, int: int, object: typing.Any, object2: typing.Any
    ) -> None: ...
    @typing.overload
    def firePropertyChange(self, propertyChangeEvent: PropertyChangeEvent) -> None: ...
    @typing.overload
    def firePropertyChange(
        self, string: str, boolean: bool, boolean2: bool
    ) -> None: ...
    @typing.overload
...
class VetoableChangeSupport(java.io.Serializable):
    ...
    def addVetoableChangeListener(
        self,
        vetoableChangeListener: typing.Union[VetoableChangeListener, typing.Callable],
    ) -> None: ...
    @typing.overload
    def addVetoableChangeListener(
        self,
...
class XMLDecoder(java.lang.AutoCloseable):
    ...
    def __init__(
        ...
        object: typing.Any,
        exceptionListener: typing.Union[ExceptionListener, typing.Callable],
    ): ...
    @typing.overload
    def __init__(
        self,
...
class BeanDescriptor(FeatureDescriptor):
    ...
    @typing.overload
    def __init__(
        self, class_: typing.Type[typing.Any], class2: typing.Type[typing.Any]
    ): ...
...
class EventSetDescriptor(FeatureDescriptor):
    ...
    def __init__(
        ...
        string: str,
        class_: typing.Type[typing.Any],
        methodDescriptorArray: typing.Union[
            typing.List["MethodDescriptor"], jpype.JArray
        ],
    ...
    def __init__(
        ...
        string: str,
        class_: typing.Type[typing.Any],
        methodArray: typing.Union[typing.List[java.lang.reflect.Method], jpype.JArray],
        method2: java.lang.reflect.Method,
        method3: java.lang.reflect.Method,
    ): ...
    @typing.overload
...
class MethodDescriptor(FeatureDescriptor):
    ...
    def __init__(
        self,
        method: java.lang.reflect.Method,
        parameterDescriptorArray: typing.Union[
            typing.List["ParameterDescriptor"], jpype.JArray
        ],
    ): ...
...
class PropertyDescriptor(FeatureDescriptor):
    ...
    @typing.overload
    def __init__(
        self, string: str, class_: typing.Type[typing.Any], string2: str, string3: str
    ): ...
    @typing.overload
    def __init__(
        self,
...
class XMLEncoder(Encoder, java.lang.AutoCloseable):
    ...
    @typing.overload
    def __init__(
        self, outputStream: java.io.OutputStream, string: str, boolean: bool, int: int
    ): ...
    def close(self) -> None: ...
    def flush(self) -> None: ...
    def getOwner(self) -> typing.Any: ...
