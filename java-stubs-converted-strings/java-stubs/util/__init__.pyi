...
class Formatter(java.io.Closeable, java.io.Flushable):
    ...
    @typing.overload
    def __init__(
        self, file: typing.Union[java.io.File, jpype.protocol.SupportsPath], string: str
    ): ...
    @typing.overload
    def __init__(
        self,
    ...
    @typing.overload
    def __init__(
        self, outputStream: java.io.OutputStream, string: str, locale: "Locale"
    ): ...
    @typing.overload
    def __init__(
        self,
    ...
    @typing.overload
    def __init__(
        self, string: str, charset: java.nio.charset.Charset, locale: "Locale"
    ): ...
    @typing.overload
    ...
    @typing.overload
    def format(
        self, locale: "Locale", string: str, *object: typing.Any
    ) -> "Formatter": ...
    ...
    class BigDecimalLayoutForm(java.lang.Enum["Formatter.BigDecimalLayoutForm"]):
        ...
        @staticmethod
        def valueOf(
            class_: typing.Type[_valueOf_0__T], string: str
        ) -> _valueOf_0__T: ...
        @typing.overload
        @staticmethod
...
class Locale(java.lang.Cloneable, java.io.Serializable):
    ...
    def filterTags(
        list: "List"["Locale.LanguageRange"],
        collection: typing.Union[
            Collection[str], typing.Sequence[str], typing.Set[str]
        ],
    ) -> "List"[str]: ...
    @typing.overload
    @staticmethod
    ...
    class LanguageRange:
        ...
        def mapEquivalents(
            list: "List"["Locale.LanguageRange"],
            map: typing.Union[
                "Map"[str, "List"[str]], typing.Mapping[str, "List"[str]]
            ],
...
class Objects:
    ...
    @staticmethod
    def requireNonNull(
        t: _requireNonNull_1__T, string: str
    ...
    def requireNonNull(
        ...
        supplier: typing.Union[
            java.util.function.Supplier[str], typing.Callable[[], str]
        ],
...
class ResourceBundle:
    ...
    @staticmethod
    def getBundle(
        string: str, locale: Locale, control: "ResourceBundle.Control"
    ) -> "ResourceBundle": ...
    @typing.overload
    @staticmethod
    def getBundle(
        string: str, control: "ResourceBundle.Control"
    ) -> "ResourceBundle": ...
    @typing.overload
    @staticmethod
    ...
    @staticmethod
    def getBundle(
        string: str, locale: Locale, classLoader: java.lang.ClassLoader
    ) -> "ResourceBundle": ...
    @typing.overload
    @staticmethod
    def getBundle(
    ...
    @staticmethod
    def getBundle(
        string: str, locale: Locale, module: java.lang.Module
    ) -> "ResourceBundle": ...
...
class TimeZone(java.io.Serializable, java.lang.Cloneable):
    ...
    @typing.overload
    @staticmethod
    def availableIDs() -> java.util.stream.Stream[str]: ...
    @typing.overload
    @staticmethod
    def availableIDs(int: int) -> java.util.stream.Stream[str]: ...
    def clone(self) -> typing.Any: ...
    @typing.overload
    @staticmethod
...
class Scanner(Iterator[str], java.io.Closeable):
    ...
    @typing.overload
    def __init__(
        self, readableByteChannel: java.nio.channels.ReadableByteChannel, string: str
    ): ...
    @typing.overload
    def __init__(
        self,
...
class Properties(Hashtable[typing.Any, typing.Any]):
    ...
    @typing.overload
    def storeToXML(
        self, outputStream: java.io.OutputStream, string: str, string2: str
    ) -> None: ...
    @typing.overload
    def storeToXML(
        self,
